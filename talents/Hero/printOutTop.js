...
var numberOfTrees1 = 3;
var numberOfTrees2 = 6;
var numberOfTrees3 = 9;
var numberOfTrees4 = 12;
var numberOfTrees5 = 15;
var numberOfTrees6 = 18;
var numberOfTrees7 = 21;
var numberOfTrees8 = 24;
var numberOfTrees9 = 27;

var talentDescriptionArray = new Array;

var imgDir = "";
massiveReplaceString += '<t1 style = "text-align: center; color: red; font-size: 40px;">This is our old Layout that is no longer supported, old links will get you to this page currently, we are working to build a translation from the orginal link to the new link. New Website is here: </t1><br>';
massiveReplaceString += '<t2 style = "text-align: center; color: red; font-size: 40px;"><a style = "color: red" href="https://asenciontc.neocities.org/">New Layout</a></t2><br>';
massiveReplaceString += '<button onclick="HideClass1()">Hide/Show Druid</button><button onclick="HideClass2()">Hide/Show Hunter</button><button onclick="HideClass3()">Hide/Show Mage</button><button onclick="HideClass4()">Hide/Show Paladin</button><button onclick="HideClass5()">Hide/Show Priest</button><button onclick="HideClass6()">Hide/Show Rogue</button><button onclick="HideClass7()">Hide/Show Shaman</button><button onclick="HideClass8()">Hide/Show Warlock</button><button onclick="HideClass9()">Hide/Show Warrior</button>';
massiveReplaceString += '<div id="talentwrap1" style="display: block;"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';

if (variableIsSite) {
	massiveReplaceString += '<div style = "position: relative; top: -12; left: 13;"><div style = "position: absolute;"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td></td>';
	if (!lg)
...
for (var printTreeID = 0; printTreeID < numberOfTrees1; printTreeID++) {
	var tier = 0;
	var treeID;		
	...
	massiveReplaceString += '<button onclick="HideTree('+ printTreeID +')">Hide/Show Tree</button>';
	...
	while (talent[i] && talent[i][0] == printTreeID &&  i != (talent.length - 1)){
		...
		//{	
			...
			massiveReplaceString += '<table border = "0" cellpadding = "3" cellspacing = "0">';
			...
			for (verticalCounter = 1; verticalCounter <= vertical; verticalCounter++)
			{
				...
				for (horizontalCounter = 1; horizontalCounter <= horizontal; horizontalCounter++)
				{
					...
					if (talent[i] && talent[i][3] == horizontalCounter && talent[i][4] == verticalCounter)
					{
						...
						{ 
							massiveReplaceString += '<span id = "requiresPoints'+ i +'" style = "color: red" class = "mySmall"><br>' + requiresRequires + ' '+' '+ requiresTalents +'</span>';
						}
...
<img src="'+ imgPath +'/images/talents/trees/'+ nlclass + printTreeID +'.png" class="p talenttreeicon" align="left"><span class = "treePoint" id="'+tree[printTreeID]+'tabPoints">'+ pointsTree[printTreeID] +'</span> <span class = "treePoints" id="'+tree[printTreeID]+'tabPointsText">'+ textPoints +'</span></nobr>\
			</div>\
		</td>\
		<td>\
...
massiveReplaceString += "</tr></table></div>";

massiveReplaceString += '<div id="talentwrap2" style="display: block;"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 3; printTreeID < numberOfTrees2; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap3"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 6; printTreeID < numberOfTrees3; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap4"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 9; printTreeID < numberOfTrees4; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap5"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 12; printTreeID < numberOfTrees5; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap6"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 15; printTreeID < numberOfTrees6; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap7"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 18; printTreeID < numberOfTrees7; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap8"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 21; printTreeID < numberOfTrees8; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += '<div id="talentwrap9"><table border = "0" cellpadding = "0" cellspacing = "0"><tr><td>';
...
//finally we get to arrange and print out all the info
for (var printTreeID = 24; printTreeID < numberOfTrees9; printTreeID++) {
	var tier = 0;
	var treeID;		
...
massiveReplaceString += "</tr></table></div><br /><br />";
...
massiveReplaceString += '<table border = "0" cellpadding = "0" cellspacing = "0" width = "100%"><tr><td width = "100%"><a onClick = "printableVersion();" style="cursor:pointer"><img src = "'+ imgPath +'/includes/images'+ lg +'/printableversion.gif" border = "0"></a></td>';
...
massiveReplaceString += '<span style = "color:ffd800;">'+ 'https://asenciontc.neocities.org/' +'?tal=<span id = "copyURL" style = "color:ffd800"></span></span><br></div>';

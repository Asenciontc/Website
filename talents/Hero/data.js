...
tree[i] = "D-Balance"; i++;
tree[i] = "D-Feral Combat"; i++;
tree[i] = "D-Restoration"; i++;
tree[i] = "H-Beast Mastery"; i++;
tree[i] = "H-Marksmanship"; i++;
tree[i] = "H-Survival"; i++;
tree[i] = "M-Arcane"; i++;
tree[i] = "M-Fire"; i++;
tree[i] = "M-Frost"; i++;
tree[i] = "P-Holy"; i++;
tree[i] = "P-Prot"; i++;
tree[i] = "P-Retribution"; i++;
tree[i] = "Priest-Discipline"; i++;
tree[i] = "Priest-Holy"; i++;
tree[i] = "Priest-Shadow"; i++;
tree[i] = "R-Assassination"; i++;
tree[i] = "R-Combat"; i++;
tree[i] = "R-Subtlety"; i++;
tree[i] = "S-Elemental"; i++;
tree[i] = "S-Enhancement"; i++;
tree[i] = "S-Restoration"; i++;
tree[i] = "W-Affliction"; i++;
tree[i] = "W-Demonology"; i++;
tree[i] = "W-Destruction"; i++;
tree[i] = "War-Arms"; i++;
tree[i] = "War-Fury"; i++;
tree[i] = "War-Protection"; i++;
...
talent[i] = [0, "Nature's Grace", 3, 2, 3]; i++;
talent[i] = [0, "Nature's Splendor", 1, 3, 3]; i++;
...
talent[i] = [0, "Improved Insect Swarm", 3, 3, 5]; i++;
...
talent[i] = [1, "Primal Fury", 2, 3, 4]; i++;
talent[i] = [1, "Primal Precision", 2, 4, 4]; i++;
...
talent[i] = [2, "Tree of Life", 1, 2, 9]; i++;
talent[i] = [2, "Improved Tree of Life", 3, 3, 9]; i++;
talent[i] = [2, "Improved Barkskin", 2, 1, 10]; i++;
talent[i] = [2, "Gift of the Earthmother", 5, 3, 10]; i++;
talent[i] = [2, "Wild Growth", 1, 2, 11]; i++;
...
talent[i] = [3, "Improved Aspect of the Hawk", 5, 2, 1]; i++;
talent[i] = [3, "Endurance Training", 5, 3, 1]; i++;
talent[i] = [3, "Focused Fire", 2, 1, 2]; i++;
talent[i] = [3, "Improved Aspect of the Monkey", 3, 2, 2]; i++; 
talent[i] = [3, "Thick Hide", 3, 3, 2]; i++;
talent[i] = [3, "Improved Revive Pet", 2, 4, 2]; i++;
talent[i] = [3, "Pathfinding", 2, 1, 3]; i++;
talent[i] = [3, "Aspect Mastery", 1, 2, 3]; i++;
talent[i] = [3, "Unleashed Fury", 5, 3, 3]; i++;
talent[i] = [3, "Improved Mend Pet", 2, 2, 4]; i++;
talent[i] = [3, "Ferocity", 5, 3, 4]; i++;
talent[i] = [3, "Spirit Bond", 2, 1, 5]; i++;
talent[i] = [3, "Intimidation", 1, 2, 5]; i++;
talent[i] = [3, "Bestial Discipline", 2, 4, 5]; i++;
talent[i] = [3, "Animal Handler", 2, 1, 6]; i++;
talent[i] = [3, "Frenzy", 5, 3, 6]; i++;
talent[i] = [3, "Ferocious Inspiration", 3, 1, 7]; i++;
talent[i] = [3, "Bestial Wrath", 1, 2, 7]; i++;
talent[i] = [3, "Catlike Reflexes", 3, 3, 7]; i++;
talent[i] = [3, "Invigoration", 2, 1, 8]; i++;
talent[i] = [3, "Serpent's Swiftness", 5, 3, 8]; i++;
talent[i] = [3, "Longevity", 3, 1, 9]; i++;
talent[i] = [3, "The Beast Within", 1, 2, 9]; i++;
talent[i] = [3, "Cobra Strikes", 3, 3, 9]; i++;
talent[i] = [3, "Kindred Spirits", 5, 2, 10]; i++;
talent[i] = [3, "Beast Mastery", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//marksmanship talents
talent[i] = [4, "Improved Concussive Shot", 2, 1, 1]; i++;
talent[i] = [4, "Focused Aim", 3, 2, 1]; i++;
talent[i] = [4, "Lethal Shots", 5, 3, 1]; i++;
talent[i] = [4, "Careful Aim", 3, 1, 2]; i++;
talent[i] = [4, "Improved Hunter's Mark", 3, 2, 2]; i++;
talent[i] = [4, "Mortal Shots", 5, 3, 2]; i++;
talent[i] = [4, "Go for the Throat", 2, 1, 3]; i++;
talent[i] = [4, "Improved Arcane Shot", 3, 2, 3]; i++;
talent[i] = [4, "Aimed Shot", 1, 3, 3]; i++;
talent[i] = [4, "Rapid Killing", 2, 4, 3]; i++;
talent[i] = [4, "Improved Stings", 3, 2, 4]; i++;
talent[i] = [4, "Efficiency", 5, 3, 4]; i++;
talent[i] = [4, "Concussive Barrage", 2, 1, 5]; i++;
talent[i] = [4, "Readiness", 1, 2, 5]; i++;
talent[i] = [4, "Barrage", 3, 3, 5]; i++;
talent[i] = [4, "Combat Experience", 2, 1, 6]; i++;
talent[i] = [4, "Ranged Weapon Specialization", 3, 4, 6]; i++;
talent[i] = [4, "Piercing Shots", 3, 1, 7]; i++;
talent[i] = [4, "Trueshot Aura", 1, 2, 7]; i++;
talent[i] = [4, "Improved Barrage", 3, 3, 7]; i++;
talent[i] = [4, "Master Marksman", 5, 2, 8]; i++;
talent[i] = [4, "Rapid Recuperation", 2, 3, 8]; i++;
talent[i] = [4, "Wild Quiver", 3, 1, 9]; i++;
talent[i] = [4, "Silencing Shot", 1, 2, 9]; i++;
talent[i] = [4, "Improved Steady Shot", 3, 3, 9]; i++;
talent[i] = [4, "Marked for Death", 5, 2, 10]; i++;
talent[i] = [4, "Chimera Shot", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//survival talents
talent[i] = [5, "Improved Tracking", 5, 1, 1]; i++;
talent[i] = [5, "Hawk Eye", 3, 2, 1]; i++;
talent[i] = [5, "Savage Strikes", 2, 3, 1]; i++;
talent[i] = [5, "Surefooted", 3, 1, 2]; i++;
talent[i] = [5, "Entrapment", 3, 2, 2]; i++;
talent[i] = [5, "Trap Mastery", 3, 3, 2]; i++;
talent[i] = [5, "Survival Instincts", 2, 4, 2]; i++;
talent[i] = [5, "Survivalist", 5, 1, 3]; i++;
talent[i] = [5, "Scatter Shot", 1, 2, 3]; i++;
talent[i] = [5, "Deflection", 3, 3, 3]; i++;
talent[i] = [5, "Survival Tactics", 2, 4, 3]; i++;
talent[i] = [5, "T.N.T.", 3, 2, 4]; i++;
talent[i] = [5, "Lock and Load", 3, 4, 4]; i++;
talent[i] = [5, "Hunter vs. Wild", 3, 1, 5]; i++;
talent[i] = [5, "Killer Instinct", 3, 2, 5]; i++;
talent[i] = [5, "Counterattack", 1, 3, 5]; i++;
talent[i] = [5, "Lightning Reflexes", 5, 1, 6]; i++;
talent[i] = [5, "Resourcefulness", 3, 3, 6]; i++;
talent[i] = [5, "Expose Weakness", 3, 1, 7]; i++;
talent[i] = [5, "Wyvern Sting", 1, 2, 7]; i++;
talent[i] = [5, "Thrill of the Hunt", 3, 3, 7]; i++;
talent[i] = [5, "Master Tactician", 5, 1, 8]; i++;
talent[i] = [5, "Noxious stings", 3, 2, 8]; i++;
talent[i] = [5, "Point of No Escape", 2, 1, 9]; i++;
talent[i] = [5, "Black Arrow", 1, 2, 9]; i++;
talent[i] = [5, "Sniper Training", 3, 4, 9]; i++;
talent[i] = [5, "Hunting Party", 3, 3, 10]; i++;
talent[i] = [5, "Explosive Shot", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//arcane talents
talent[i] = [6, "Arcane Subtlety", 2, 1, 1]; i++;
talent[i] = [6, "Arcane Focus", 3, 2, 1]; i++;
talent[i] = [6, "Arcane Stability", 5, 3, 1]; i++;
talent[i] = [6, "Arcane Fortitude", 3, 1, 2]; i++;
talent[i] = [6, "Magic Absorption", 2, 2, 2]; i++;
talent[i] = [6, "Arcane Concentration", 5, 3, 2]; i++;
talent[i] = [6, "Magic Attunement", 2, 1, 3]; i++;
talent[i] = [6, "Spell Impact", 3, 2, 3]; i++;
talent[i] = [6, "Student of the Mind", 3, 3, 3]; i++;
talent[i] = [6, "Focus Magic", 1, 4, 3]; i++;
talent[i] = [6, "Arcane Shielding", 2, 1, 4]; i++;
talent[i] = [6, "Improved Counterspell", 2, 2, 4]; i++;
talent[i] = [6, "Arcane Meditation", 3, 3, 4]; i++;
talent[i] = [6, "Torment the Weak", 3, 4, 4]; i++;
talent[i] = [6, "Improved Blink", 2, 1, 5]; i++;
talent[i] = [6, "Presence of Mind", 1, 2, 5]; i++;
talent[i] = [6, "Arcane Mind", 5, 4, 5]; i++;
talent[i] = [6, "Prismatic Cloak", 3, 1, 6]; i++;
talent[i] = [6, "Arcane Instability", 3, 2, 6]; i++;
talent[i] = [6, "Arcane Potency", 2, 3, 6]; i++;
talent[i] = [6, "Arcane Empowerment", 3, 1, 7]; i++;
talent[i] = [6, "Arcane Power", 1, 2, 7]; i++;
talent[i] = [6, "Incanter's Absorption", 3, 3, 7]; i++;
talent[i] = [6, "Arcane Flows", 2, 2, 8]; i++;
talent[i] = [6, "Mind Mastery", 5, 3, 8]; i++;
talent[i] = [6, "Slow", 1, 2, 9]; i++;
talent[i] = [6, "Missile Barrage", 5, 3, 9]; i++;
talent[i] = [6, "Netherwind Presence", 3, 2, 10]; i++;
talent[i] = [6, "Spell Power", 2, 3, 10]; i++;
talent[i] = [6, "Arcane Barrage", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//fire talents
talent[i] = [7, "Improved Fire Blast", 2, 1, 1]; i++;
talent[i] = [7, "Incineration", 3, 2, 1]; i++;
talent[i] = [7, "Improved Fireball", 5, 3, 1]; i++;
talent[i] = [7, "Ignite", 5, 1, 2]; i++;
talent[i] = [7, "Burning Determination", 2, 2, 2]; i++;
talent[i] = [7, "World in Flames", 3, 3, 2]; i++;
talent[i] = [7, "Flame Throwing", 2, 1, 3]; i++;
talent[i] = [7, "Impact", 3, 2, 3]; i++;
talent[i] = [7, "Pyroblast", 1, 3, 3]; i++;
talent[i] = [7, "Burning Soul", 2, 4, 3]; i++;
talent[i] = [7, "Improved Scorch", 3, 1, 4]; i++;
talent[i] = [7, "Molten Shields", 2, 2, 4]; i++;
talent[i] = [7, "Master of Elements", 3, 4, 4]; i++;
talent[i] = [7, "Playing with Fire", 3, 1, 5]; i++;
talent[i] = [7, "Critical Mass", 3, 2, 5]; i++;
talent[i] = [7, "Blast Wave", 1, 3, 5]; i++;
talent[i] = [7, "Blazing Speed", 2, 1, 6]; i++;
talent[i] = [7, "Fire Power", 5, 3, 6]; i++;
talent[i] = [7, "Pyromaniac", 3, 1, 7]; i++;
talent[i] = [7, "Combustion", 1, 2, 7]; i++;
talent[i] = [7, "Molten Fury", 2, 3, 7]; i++;
talent[i] = [7, "Fiery Payback", 2, 1, 8]; i++;
talent[i] = [7, "Empowered Fire", 3, 3, 8]; i++;
talent[i] = [7, "Firestarter", 2, 1, 9, [i+1,1]]; i++;
talent[i] = [7, "Dragon's Breath", 1, 2, 9]; i++;
talent[i] = [7, "Hot Streak", 3, 3, 9]; i++;
talent[i] = [7, "Burnout", 5, 2, 10]; i++;
talent[i] = [7, "Living Bomb", 1, 2, 11]; i++;
...
//frost talents
talent[i] = [8, "Frostbite", 3, 1, 1]; i++;
talent[i] = [8, "Improved Frostbolt", 5, 2, 1]; i++;
talent[i] = [8, "Ice Floes", 3, 3, 1]; i++;
talent[i] = [8, "Ice Shards", 3, 1, 2]; i++;
talent[i] = [8, "Frost Warding", 2, 2, 2]; i++;
talent[i] = [8, "Elemental Precision", 3, 3, 2]; i++;
talent[i] = [8, "Permafrost", 3, 4, 2]; i++;
talent[i] = [8, "Piercing Ice", 3, 1, 3]; i++;
talent[i] = [8, "Icy Veins", 1, 2, 3]; i++;
talent[i] = [8, "Improved Blizzard", 3, 3, 3]; i++;
talent[i] = [8, "Arctic Reach", 2, 1, 4]; i++;
talent[i] = [8, "Frost Channeling", 3, 2, 4]; i++;
talent[i] = [8, "Shatter", 3, 3, 4]; i++;
talent[i] = [8, "Cold Snap", 1, 2, 5]; i++;
talent[i] = [8, "Improved Cone of Cold", 3, 3, 5]; i++;
talent[i] = [8, "Frozen Core", 3, 4, 5]; i++;
talent[i] = [8, "Cold as Ice", 2, 1, 6]; i++;
talent[i] = [8, "Winter's Chill", 3, 3, 6]; i++;
talent[i] = [8, "Shattered Barrier", 2, 1, 7, [i+1,1]]; i++;
talent[i] = [8, "Ice Barrier", 1, 2, 7]; i++;
talent[i] = [8, "Arctic Winds", 5, 3, 7]; i++;
talent[i] = [8, "Empowered Frostbolt", 3, 2, 8]; i++;
talent[i] = [8, "Fingers of Frost", 2, 3, 8]; i++;
talent[i] = [8, "Brain Freeze", 3, 1, 9]; i++;
talent[i] = [8, "Summon Water Elemental", 1, 2, 9]; i++;
talent[i] = [8, "Improved Water Elemental", 3, 3, 9]; i++;
talent[i] = [8, "Chilled to the Bone", 5, 2, 10]; i++;
talent[i] = [8, "Deep Freeze", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//Holy Talents

talent[i] = [9, "Spiritual Focus", 5, 2, 1]; i++;
talent[i] = [9, "Seals of the Pure", 5, 3, 1]; i++; 
talent[i] = [9, "Healing Light", 3, 1, 2]; i++;
talent[i] = [9, "Divine Intellect", 5, 2, 2]; i++;
talent[i] = [9, "Unyielding Faith", 2, 3, 2]; i++;
talent[i] = [9, "Aura Mastery", 1, 1, 3]; i++;
talent[i] = [9, "Illumination", 5, 2, 3]; i++;
talent[i] = [9, "Improved Lay on Hands", 2, 3, 3]; i++;
talent[i] = [9, "Improved Concentration Aura", 3, 1, 4]; i++;
talent[i] = [9, "Improved Blessing of Wisdom", 2, 3, 4]; i++;
talent[i] = [9, "Blessed Hands", 2, 4, 4]; i++;
talent[i] = [9, "Pure of Heart", 2, 1, 5]; i++;
talent[i] = [9, "Divine Favor", 1, 2, 5]; i++;
talent[i] = [9, "Sanctified Light", 3, 3, 5]; i++;
talent[i] = [9, "Purifying Power", 2, 1, 6]; i++;
talent[i] = [9, "Holy Power", 5, 3, 6]; i++;
talent[i] = [9, "Light's Grace", 3, 1, 7]; i++;
talent[i] = [9, "Holy Shock", 1, 2, 7]; i++;
talent[i] = [9, "Blessed Life", 3, 3, 7]; i++;
talent[i] = [9, "Sacred Cleansing", 3, 1, 8]; i++;
talent[i] = [9, "Holy Guidance", 5, 3, 8]; i++;
talent[i] = [9, "Divine Illumination", 1, 1, 9]; i++;
talent[i] = [9, "Judgements of the Pure", 5, 3, 9]; i++;
talent[i] = [9, "Infusion of Light", 2, 2, 10]; i++;
talent[i] = [9, "Enlightened Judgements", 2, 3, 10]; i++;
talent[i] = [9, "Beacon of Light", 1, 2, 11]; i++;
...
talent[i] = [10, "Divinity", 5, 2, 1]; i++;
talent[i] = [10, "Divine Strength", 5, 3, 1]; i++;
talent[i] = [10, "Stoicism", 3, 1, 2]; i++;
talent[i] = [10, "Guardian's Favor", 2, 2, 2]; i++;
talent[i] = [10, "Anticipation", 5, 3, 2]; i++;
talent[i] = [10, "Divine Sacrifice", 1, 1, 3]; i++;
talent[i] = [10, "Improved Righteous Fury", 3, 2, 3]; i++;
talent[i] = [10, "Toughness", 5, 3, 3]; i++;
talent[i] = [10, "Divine Guardian", 2, 1, 4]; i++;
talent[i] = [10, "Improved Hammer of Justice", 2, 2, 4]; i++;
talent[i] = [10, "Improved Devotion Aura", 3, 3, 4]; i++;
talent[i] = [10, "Blessing of Sanctuary", 1, 2, 5]; i++;
talent[i] = [10, "Reckoning", 5, 3, 5]; i++;
talent[i] = [10, "Sacred Duty", 2, 1, 6]; i++;
talent[i] = [10, "One-Handed Weapon Specialization", 3, 3, 6]; i++;
talent[i] = [10, "Spiritual Attunement", 2, 1, 7]; i++;
talent[i] = [10, "Holy Shield", 1, 2, 7]; i++;
talent[i] = [10, "Ardent Defender", 3, 3, 7]; i++;
talent[i] = [10, "Redoubt", 3, 1, 8]; i++;
talent[i] = [10, "Combat Expertise", 3, 3, 8]; i++;
talent[i] = [10, "Touched by the Light", 3, 1, 9]; i++;
talent[i] = [10, "Avenger's Shield", 1, 2, 9]; i++;
talent[i] = [10, "Guarded by the Light", 2, 3, 9]; i++;
talent[i] = [10, "Shield of the Templar", 3, 2, 10]; i++;
talent[i] = [10, "Judgements of the Just", 2, 3, 10]; i++;
talent[i] = [10, "Hammer of the Righteous", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//retribution talents
talent[i] = [11, "Deflection", 5, 2, 1]; i++;
talent[i] = [11, "Benediction", 5, 3, 1]; i++;
talent[i] = [11, "Improved Judgements", 2, 1, 2]; i++;
talent[i] = [11, "Heart of the Crusader", 3, 2, 2]; i++;
talent[i] = [11, "Improved Blessing of Might", 2, 3, 2]; i++;
talent[i] = [11, "Vindication", 2, 1, 3]; i++;
talent[i] = [11, "Conviction", 5, 2, 3]; i++;
talent[i] = [11, "Seal of Command", 1, 3, 3]; i++;
talent[i] = [11, "Pursuit of Justice", 2, 4, 3]; i++;
talent[i] = [11, "Eye for an Eye", 2, 1, 4]; i++;
talent[i] = [11, "Sanctified Seals", 3, 3, 4]; i++;
talent[i] = [11, "Crusade", 3, 4, 4]; i++;
talent[i] = [11, "Two-Handed Weapon Specialization", 3, 1, 5]; i++;
talent[i] = [11, "Sanctified Retribution", 1, 3, 5]; i++;
talent[i] = [11, "Vengeance", 3, 2, 6]; i++;
talent[i] = [11, "Divine Purpose", 2, 3, 6]; i++;
talent[i] = [11, "The Art of War", 2, 1, 7]; i++;
talent[i] = [11, "Repentance", 1, 2, 7]; i++;
talent[i] = [11, "Judgements of the Wise", 3, 3, 7]; i++;
talent[i] = [11, "Fanaticism", 3, 2, 8]; i++;
talent[i] = [11, "Sanctified Wrath", 2, 3, 8]; i++;
talent[i] = [11, "Swift Retribution", 3, 1, 9]; i++;
talent[i] = [11, "Crusader Strike", 1, 2, 9]; i++;
talent[i] = [11, "Sheath of Light", 5, 3, 9]; i++;
talent[i] = [11, "Righteous Vengeance", 3, 2, 10]; i++;
talent[i] = [11, "Divine Storm", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//Discipline Talents
talent[i] = [12, "Unbreakable Will", 5, 2, 1]; i++;
talent[i] = [12, "Twin Disciplines", 5, 3, 1]; i++;
talent[i] = [12, "Silent Resolve", 3, 1, 2]; i++;
talent[i] = [12, "Improved Inner Fire", 3, 2, 2]; i++;
talent[i] = [12, "Improved Power Word: Fortitude", 2, 3, 2]; i++;
talent[i] = [12, "Martyrdom", 2, 4, 2]; i++; 
talent[i] = [12, "Meditation", 3, 1, 3]; i++;
talent[i] = [12, "Inner Focus", 1, 2, 3]; i++;
talent[i] = [12, "Improved Power Word: Shield", 3, 3, 3]; i++;
talent[i] = [12, "Absolution", 3, 1, 4]; i++;
talent[i] = [12, "Mental Agility", 3, 2, 4]; i++;
talent[i] = [12, "Improved Mana Burn", 2, 4, 4]; i++;
talent[i] = [12, "Reflective Shield", 2, 1, 5]; i++;
talent[i] = [12, "Mental Strength", 5, 2, 5]; i++;
talent[i] = [12, "Soul Warding", 1, 3, 5]; i++;
talent[i] = [12, "Focused Power", 2, 1, 6]; i++;
talent[i] = [12, "Enlightenment", 3, 3, 6]; i++;
talent[i] = [12, "Focused Will", 3, 1, 7]; i++;
talent[i] = [12, "Power Infusion", 1, 2, 7]; i++;
talent[i] = [12, "Improved Flash Heal", 3, 3, 7]; i++;
talent[i] = [12, "Renewed Hope", 2, 1, 8]; i++;
talent[i] = [12, "Rapture", 3, 2, 8]; i++;
talent[i] = [12, "Aspiration", 2, 3, 8]; i++;
talent[i] = [12, "Divine Aegis", 3, 1, 9]; i++;
talent[i] = [12, "Pain Suppression", 1, 2, 9]; i++;
talent[i] = [12, "Grace", 2, 3, 9]; i++;
talent[i] = [12, "Borrowed Time", 5, 2, 10]; i++;
talent[i] = [12, "Penance", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//holy talents
talent[i] = [13, "Healing Focus", 2, 1, 1]; i++;
talent[i] = [13, "Improved Renew", 3, 2, 1]; i++;
talent[i] = [13, "Holy Specialization", 5, 3, 1]; i++;
talent[i] = [13, "Spell Warding", 5, 2, 2]; i++;
talent[i] = [13, "Divine Fury", 5, 3, 2]; i++;
talent[i] = [13, "Desperate Prayer", 1, 1, 3]; i++;
talent[i] = [13, "Blessed Recovery", 3, 2, 3]; i++;
talent[i] = [13, "Inspiration", 3, 4, 3]; i++;
talent[i] = [13, "Holy Reach", 2, 1, 4]; i++;
talent[i] = [13, "Improved Healing", 3, 2, 4]; i++;
talent[i] = [13, "Searing Light", 5, 3, 4]; i++;
talent[i] = [13, "Healing Prayers", 2, 1, 5]; i++;
talent[i] = [13, "Spirit of Redemption", 1, 2, 5]; i++;
talent[i] = [13, "Spiritual Guidance", 5, 3, 5]; i++;
talent[i] = [13, "Surge of Light", 2, 1, 6]; i++; 
talent[i] = [13, "Spiritual Healing", 5, 3, 6]; i++;
talent[i] = [13, "Holy Concentration", 3, 1, 7]; i++; 
talent[i] = [13, "Lightwell", 1, 2, 7]; i++;
talent[i] = [13, "Blessed Resilience", 3, 3, 7]; i++;
talent[i] = [13, "Body and Soul", 2, 1, 8]; i++;
talent[i] = [13, "Empowered Healing", 5, 2, 8]; i++;
talent[i] = [13, "Serendipity", 3, 3, 8]; i++;
talent[i] = [13, "Empowered Renew", 3, 1, 9]; i++;
talent[i] = [13, "Circle of Healing", 1, 2, 9]; i++;
talent[i] = [13, "Test of Faith", 3, 3, 9]; i++; 
talent[i] = [13, "Divine Providence", 5, 2, 10]; i++; 
talent[i] = [13, "Guardian Spirit", 1, 2, 11]; i++; 
treeStartStop[t] = i -1;
t++;

//shadow talents
talent[i] = [14, "Spirit Tap", 3, 1, 1]; i++;
talent[i] = [14, "Improved Spirit Tap", 2, 2, 1]; i++;
talent[i] = [14, "Darkness", 5, 3, 1]; i++;
talent[i] = [14, "Shadow Affinity", 3, 1, 2]; i++;
talent[i] = [14, "Improved Shadow Word: Pain", 2, 2, 2]; i++;
talent[i] = [14, "Shadow Focus", 3, 3, 2]; i++;
talent[i] = [14, "Improved Psychic Scream", 2, 1, 3]; i++;
talent[i] = [14, "Improved Mind Blast", 5, 2, 3]; i++;
talent[i] = [14, "Mind Flay", 1, 3, 3]; i++;
talent[i] = [14, "Veiled Shadows", 2, 2, 4]; i++;
talent[i] = [14, "Shadow Reach", 2, 3, 4]; i++;
talent[i] = [14, "Shadow Weaving", 3, 4, 4]; i++;
talent[i] = [14, "Silence", 1, 1, 5]; i++;
talent[i] = [14, "Vampiric Embrace", 1, 2, 5]; i++;
talent[i] = [14, "Improved Vampiric Embrace", 2, 3, 5]; i++;
talent[i] = [14, "Focused Mind", 3, 4, 5]; i++; 
talent[i] = [14, "Mind Melt", 2, 1, 6]; i++;
talent[i] = [14, "Improved Devouring Plague", 3, 3, 6]; i++;
talent[i] = [14, "Shadowform", 1, 2, 7]; i++;
talent[i] = [14, "Shadow Power", 5, 3, 7]; i++;
talent[i] = [14, "Improved Shadowform", 2, 1, 8]; i++;
talent[i] = [14, "Misery", 3, 3, 8]; i++; 
talent[i] = [14, "Psychic Horror", 1, 1, 9]; i++;
talent[i] = [14, "Vampiric Touch", 1, 2, 9]; i++; 
talent[i] = [14, "Pain and Suffering", 3, 3, 9]; i++;
talent[i] = [14, "Twisted Faith", 5, 3, 10]; i++;
talent[i] = [14, "Dispersion", 1, 2, 11]; i++; 
treeStartStop[t] = i -1;
t++;

//assasination talents
talent[i] = [15, "Improved Eviscerate", 3, 1, 1]; i++;
talent[i] = [15, "Remorseless Attacks", 2, 2, 1]; i++;
talent[i] = [15, "Malice", 5, 3, 1]; i++;
talent[i] = [15, "Ruthlessness", 3, 1, 2]; i++; 
talent[i] = [15, "Blood Spatter", 2, 2, 2]; i++;
talent[i] = [15, "Puncturing Wounds", 3, 4, 2]; i++;
talent[i] = [15, "Vigor", 1, 1, 3]; i++;
talent[i] = [15, "Improved Expose Armor", 2, 2, 3]; i++;
talent[i] = [15, "Lethality", 5, 3, 3]; i++;
talent[i] = [15, "Vile Poisons", 3, 2, 4]; i++;
talent[i] = [15, "Improved Poisons", 5, 3, 4]; i++;
talent[i] = [15, "Fleet Footed", 3, 1, 5]; i++;
talent[i] = [15, "Cold Blood", 1, 2, 5]; i++;
talent[i] = [15, "Improved Kidney Shot", 3, 3, 5]; i++;
talent[i] = [15, "Quick Recovery", 2, 4, 5]; i++;
talent[i] = [15, "Seal Fate", 5, 2, 6]; i++;
talent[i] = [15, "Murder", 2, 3, 6]; i++;
talent[i] = [15, "Deadly Brew", 2, 1, 7]; i++;
talent[i] = [15, "Overkill", 1, 2, 7]; i++;
talent[i] = [15, "Deadened Nerves", 3, 3, 7]; i++;
talent[i] = [15, "Focused Attacks", 3, 1, 8]; i++;
talent[i] = [15, "Find Weakness", 3, 3, 8]; i++;
talent[i] = [15, "Master Poisoner", 3, 1, 9]; i++;
talent[i] = [15, "Mutilate", 1, 2, 9]; i++;
talent[i] = [15, "Turn the Tables", 3, 3, 9]; i++;
talent[i] = [15, "Cut to the Chase", 5, 2, 10]; i++;
talent[i] = [15, "Hunger For Blood", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//combat Talents
talent[i] = [16, "Improved Gouge", 3, 1, 1]; i++;
talent[i] = [16, "Improved Sinister Strike", 2, 2, 1]; i++;
talent[i] = [16, "Dual Wield Specialization", 5, 3, 1]; i++;
talent[i] = [16, "Improved Slice and Dice", 2, 1, 2]; i++;
talent[i] = [16, "Deflection", 3, 2, 2]; i++;
talent[i] = [16, "Precision", 5, 4, 2]; i++;
talent[i] = [16, "Endurance", 2, 1, 3]; i++;
talent[i] = [16, "Riposte", 1, 2, 3]; i++;
talent[i] = [16, "Close Quarters Combat", 5, 3, 3]; i++;
talent[i] = [16, "Improved Kick", 2, 1, 4]; i++;
talent[i] = [16, "Improved Sprint", 2, 2, 4]; i++;
talent[i] = [16, "Lightning Reflexes", 3, 3, 4]; i++;
talent[i] = [16, "Aggression", 5, 4, 4]; i++;
talent[i] = [16, "Mace Specialization", 5, 1, 5]; i++;
talent[i] = [16, "Blade Flurry", 1, 2, 5]; i++;
talent[i] = [16, "Sword Specialization", 5, 3, 5]; i++;
talent[i] = [16, "Weapon Expertise", 2, 2, 6]; i++;
talent[i] = [16, "Blade Twisting", 2, 3, 6]; i++;
talent[i] = [16, "Vitality", 3, 1, 7]; i++;
talent[i] = [16, "Adrenaline Rush", 1, 2, 7]; i++;
talent[i] = [16, "Nerves of Steel", 2, 3, 7]; i++;
talent[i] = [16, "Throwing Specialization", 2, 1, 8]; i++;
talent[i] = [16, "Combat Potency", 5, 3, 8]; i++;
talent[i] = [16, "Unfair Advantage", 2, 1, 9]; i++;
talent[i] = [16, "Surprise Attacks", 1, 2, 9]; i++;
talent[i] = [16, "Savage Combat", 2, 3, 9]; i++;
talent[i] = [16, "Prey on the Weak", 5, 2, 10]; i++;
talent[i] = [16, "Killing Spree", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//subtelty talents
talent[i] = [17, "Relentless Strikes", 5, 1, 1]; i++;
talent[i] = [17, "Master of Deception", 5, 2, 1]; i++;
talent[i] = [17, "Opportunity", 2, 3, 1]; i++;
talent[i] = [17, "Sleight of Hand", 2, 1, 2]; i++;
talent[i] = [17, "Dirty Tricks", 2, 2, 2]; i++;
talent[i] = [17, "Camouflage", 3, 3, 2]; i++;
talent[i] = [17, "Elusiveness", 2, 1, 3]; i++;
talent[i] = [17, "Ghostly Strike", 1, 2, 3]; i++;
talent[i] = [17, "Serrated Blades", 3, 3, 3]; i++;
talent[i] = [17, "Setup", 3, 1, 4]; i++;
talent[i] = [17, "Initiative", 3, 2, 4]; i++;
talent[i] = [17, "Improved Ambush", 2, 3, 4]; i++;
talent[i] = [17, "Heightened Senses", 2, 1, 5]; i++;
talent[i] = [17, "Preparation", 1, 2, 5]; i++;
talent[i] = [17, "Dirty Deeds", 2, 3, 5]; i++;
talent[i] = [17, "Hemorrhage", 1, 4, 5]; i++;
talent[i] = [17, "Master of Subtlety", 3, 1, 6]; i++;
talent[i] = [17, "Deadliness", 5, 3, 6]; i++;
talent[i] = [17, "Enveloping Shadows", 3, 1, 7]; i++;
talent[i] = [17, "Premeditation", 1, 2, 7]; i++;
talent[i] = [17, "Cheat Death", 3, 3, 7]; i++;
talent[i] = [17, "Sinister Calling", 5, 2, 8]; i++;
talent[i] = [17, "Waylay", 2, 3, 8]; i++;
talent[i] = [17, "Honor Among Thieves", 3, 1, 9]; i++;
talent[i] = [17, "Shadowstep", 1, 2, 9]; i++;
talent[i] = [17, "Filthy Tricks", 2, 3, 9]; i++;
talent[i] = [17, "Slaughter from the Shadows", 5, 2, 10]; i++;
talent[i] = [17, "Shadow Dance", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//elemental talents
talent[i] = [18, "Convection", 5, 2, 1]; i++;
talent[i] = [18, "Concussion", 5, 3, 1]; i++;
talent[i] = [18, "Call of Flame", 3, 1, 2]; i++;
talent[i] = [18, "Elemental Warding", 3, 2, 2]; i++; 
talent[i] = [18, "Elemental Devastation", 3, 3, 2]; i++;
talent[i] = [18, "Reverberation", 5, 1, 3]; i++;
talent[i] = [18, "Elemental Focus", 1, 2, 3]; i++;
talent[i] = [18, "Elemental Fury", 5, 3, 3]; i++;
talent[i] = [18, "Improved Fire Nova Totem", 2, 1, 4]; i++;
talent[i] = [18, "Eye of the Storm", 3, 4, 4]; i++;
talent[i] = [18, "Elemental Reach", 2, 1, 5]; i++;
talent[i] = [18, "Call of Thunder", 1, 2, 5]; i++;
talent[i] = [18, "Unrelenting Storm", 3, 4, 5]; i++;
talent[i] = [18, "Elemental Precision", 3, 1, 6]; i++;
talent[i] = [18, "Lightning Mastery", 5, 3, 6]; i++;
talent[i] = [18, "Elemental Mastery", 1, 2, 7]; i++;
talent[i] = [18, "Storm, Earth and Fire", 3, 3, 7]; i++;
talent[i] = [18, "Booming Echoes", 2, 1, 8]; i++;
talent[i] = [18, "Elemental Oath", 2, 2, 8]; i++;
talent[i] = [18, "Lightning Overload", 3, 3, 8]; i++;
talent[i] = [18, "Astral Shift", 3, 1, 9]; i++;
talent[i] = [18, "Totem of Wrath", 1, 2, 9]; i++;
talent[i] = [18, "Lava Flows", 3, 3, 9]; i++;
talent[i] = [18, "shamanism", 5, 2, 10]; i++;
talent[i] = [18, "Thunderstorm", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//enhancement talents
talent[i] = [19, "Enhancing Totems", 3, 1, 1]; i++;
talent[i] = [19, "Earth's Grasp", 2, 2, 1]; i++;
talent[i] = [19, "Ancestral Knowledge", 5, 3, 1]; i++;
talent[i] = [19, "Guardian Totems", 2, 1, 2]; i++;
talent[i] = [19, "Thundering Strikes", 5, 2, 2]; i++;
talent[i] = [19, "Improved Ghost Wolf", 2, 3, 2]; i++;
talent[i] = [19, "Improved Shields", 3, 4, 2]; i++;
talent[i] = [19, "Elemental Weapons", 3, 1, 3]; i++;
talent[i] = [19, "Shamanistic Focus", 1, 3, 3]; i++;
talent[i] = [19, "Anticipation", 3, 4, 3]; i++;
talent[i] = [19, "Flurry", 5, 2, 4]; i++;
talent[i] = [19, "Toughness", 5, 3, 4]; i++;
talent[i] = [19, "Improved Windfury Totem", 2, 1, 5]; i++;
talent[i] = [19, "Spirit Weapons", 3, 2, 5]; i++;
talent[i] = [19, "Mental Dexterity", 3, 3, 5]; i++;
talent[i] = [19, "Unleashed Rage", 3, 1, 6]; i++;  
talent[i] = [19, "Weapon Mastery", 3, 3, 6]; i++;
talent[i] = [19, "Frozen Power", 2, 4, 6]; i++;
talent[i] = [19, "Dual Wield Specialization", 3, 1, 7]; i++;
talent[i] = [19, "Dual Wield", 1, 2, 7]; i++;
talent[i] = [19, "Stormstrike", 1, 3, 7]; i++;
talent[i] = [19, "Static Shock", 5, 1, 8]; i++;
talent[i] = [19, "Lava Lash", 1, 2, 8]; i++;
talent[i] = [19, "Improved Stormstrike", 2, 3, 8]; i++;
talent[i] = [19, "Mental Quickness", 5, 1, 9]; i++;
talent[i] = [19, "Shamanistic Rage", 1, 2, 9]; i++;
talent[i] = [19, "Earthen Power", 2, 3, 9]; i++;
talent[i] = [19, "Maelstrom Weapon", 5, 2, 10]; i++;
talent[i] = [19, "Feral Spirit", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//restoration talents
talent[i] = [20, "Improved Healing Wave", 5, 2, 1]; i++;
talent[i] = [20, "Totemic Focus", 5, 3, 1]; i++;
talent[i] = [20, "Improved Reincarnation", 2, 1, 2]; i++;
talent[i] = [20, "Healing Grace", 3, 2, 2]; i++;
talent[i] = [20, "Tidal Focus", 5, 3, 2]; i++;
talent[i] = [20, "Improved Water Shield", 3, 1, 3]; i++;
talent[i] = [20, "Healing Focus", 3, 2, 3]; i++;
talent[i] = [20, "Tidal Force", 1, 3, 3]; i++;
talent[i] = [20, "Ancestral Healing", 3, 4, 3]; i++;
talent[i] = [20, "Restorative Totems", 3, 2, 4]; i++;
talent[i] = [20, "Tidal Mastery", 5, 3, 4]; i++;
talent[i] = [20, "Healing Way", 3, 1, 5]; i++;
talent[i] = [20, "Nature's Swiftness", 1, 3, 5]; i++;
talent[i] = [20, "Focused Mind", 3, 4, 5]; i++;
talent[i] = [20, "Purification", 5, 3, 6]; i++;
talent[i] = [20, "Nature's Guardian", 5, 1, 7]; i++;
talent[i] = [20, "Mana Tide Totem", 1, 2, 7]; i++;
talent[i] = [20, "Cleanse Spirit", 1, 3, 7]; i++;
talent[i] = [20, "Blessing of the Eternals", 2, 1, 8]; i++;
talent[i] = [20, "Improved Chain Heal", 2, 2, 8]; i++;
talent[i] = [20, "Nature's Blessing", 3, 3, 8]; i++;
talent[i] = [20, "Ancestral Awakening", 3, 1, 9]; i++;
talent[i] = [20, "Earth Shield", 1, 2, 9,]; i++;
talent[i] = [20, "Improved Earth Shield", 2, 3, 9]; i++;
talent[i] = [20, "Tidal Waves", 5, 2, 10,]; i++;
talent[i] = [20, "Riptide", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//afflicion talents
talent[i] = [21, "Improved Curse of Agony", 2, 1, 1]; i++;
talent[i] = [21, "Suppression", 3, 2, 1]; i++;
talent[i] = [21, "Improved Corruption", 5, 3, 1]; i++;
talent[i] = [21, "Frailty", 2, 1, 2]; i++;
talent[i] = [21, "Improved Drain Soul", 2, 2, 2]; i++; 
talent[i] = [21, "Improved Life Tap", 2, 3, 2]; i++;
talent[i] = [21, "Soul Siphon", 2, 4, 2]; i++;
talent[i] = [21, "Improved Fear", 2, 1, 3]; i++;
talent[i] = [21, "Fel Concentration", 3, 2, 3]; i++;
talent[i] = [21, "Amplify Curse", 1, 3, 3]; i++;
talent[i] = [21, "Grim Reach", 2, 1, 4]; i++;
talent[i] = [21, "Nightfall", 2, 2, 4]; i++;
talent[i] = [21, "Empowered Corruption", 3, 4, 4]; i++;
talent[i] = [21, "Shadow Embrace", 5, 1, 5]; i++;
talent[i] = [21, "Siphon Life", 1, 2, 5]; i++;
talent[i] = [21, "Curse of Exhaustion", 1, 3, 5]; i++;
talent[i] = [21, "Improved Felhunter", 2, 1, 6]; i++;
talent[i] = [21, "Shadow Mastery", 5, 2, 6]; i++;
talent[i] = [21, "Eradication", 3, 1, 7]; i++;
talent[i] = [21, "Contagion", 5, 2, 7]; i++;
talent[i] = [21, "Dark Pact", 1, 3, 7]; i++;
talent[i] = [21, "Improved Howl of Terror", 2, 1, 8]; i++;
talent[i] = [21, "Malediction", 3, 3, 8]; i++;
talent[i] = [21, "Death's Embrace", 3, 1, 9]; i++;
talent[i] = [21, "Unstable Affliction", 1, 2, 9]; i++;
talent[i] = [21, "Pandemic", 1, 3, 9]; i++;
talent[i] = [21, "Everlasting Affliction", 5, 2, 10]; i++;
talent[i] = [21, "Haunt", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//demonology talents
talent[i] = [22, "Improved Healthstone", 2, 1, 1]; i++;
talent[i] = [22, "Improved Imp", 3, 2, 1]; i++;
talent[i] = [22, "Demonic Embrace", 3, 3, 1]; i++;
talent[i] = [22, "Fel Synergy", 2, 4, 1]; i++;
talent[i] = [22, "Improved Health Funnel", 2, 1, 2]; i++;
talent[i] = [22, "Demonic Brutality", 3, 2, 2]; i++;
talent[i] = [22, "Fel Vitality", 3, 3, 2]; i++;
talent[i] = [22, "Improved Succubus", 3, 1, 3]; i++;
talent[i] = [22, "Soul Link", 1, 2, 3]; i++;
talent[i] = [22, "Fel Domination", 1, 3, 3]; i++;
talent[i] = [22, "Demonic Aegis", 3, 4, 3]; i++;
talent[i] = [22, "Unholy Power", 5, 2, 4]; i++;
talent[i] = [22, "Master Summoner", 2, 3, 4]; i++;
talent[i] = [22, "Mana Feed", 1, 1, 5]; i++;;
talent[i] = [22, "Master Conjuror", 2, 3, 5]; i++;
talent[i] = [22, "Master Demonologist", 5, 2, 6]; i++;
talent[i] = [22, "Molten Core", 3, 3, 6]; i++;
talent[i] = [22, "Demonic Resilience", 3, 1, 7]; i++;
talent[i] = [22, "Demonic Empowerment", 1, 2, 7]; i++;
talent[i] = [22, "Demonic Knowledge", 3, 3, 7]; i++;
talent[i] = [22, "Demonic Tactics", 5, 2, 8]; i++;
talent[i] = [22, "Decimation", 2, 3, 8]; i++;
talent[i] = [22, "Improved Demonic Tactics", 3, 1, 9]; i++;
talent[i] = [22, "Summon Felguard", 1, 2, 9]; i++;
talent[i] = [22, "Nemesis", 3, 3, 9]; i++;
talent[i] = [22, "Demonic Pact", 5, 2, 10]; i++;
talent[i] = [22, "Metamorphosis", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//destruction talents
talent[i] = [23, "Improved Shadow Bolt", 5, 2, 1]; i++;
talent[i] = [23, "Bane", 5, 3, 1]; i++;
talent[i] = [23, "Aftermath", 2, 1, 2]; i++;
talent[i] = [23, "Molten Skin", 3, 2, 2]; i++;
talent[i] = [23, "Cataclysm", 3, 3, 2]; i++;
talent[i] = [23, "Demonic Power", 2, 1, 3]; i++;
talent[i] = [23, "Shadowburn", 1, 2, 3]; i++;
talent[i] = [23, "Ruin", 5, 3, 3]; i++;
talent[i] = [23, "Intensity", 2, 1, 4]; i++;
talent[i] = [23, "Destructive Reach", 2, 2, 4]; i++;
talent[i] = [23, "Improved Searing Pain", 3, 4, 4]; i++;
talent[i] = [23, "Backlash", 3, 1, 5]; i++;
talent[i] = [23, "Improved Immolate", 3, 2, 5]; i++;
talent[i] = [23, "Devastation", 1, 3, 5]; i++;
talent[i] = [23, "Nether Protection", 3, 1, 6]; i++;
talent[i] = [23, "Emberstorm", 5, 3, 6]; i++;
talent[i] = [23, "Conflagrate", 1, 2, 7]; i++;
talent[i] = [23, "Soul Leech", 3, 3, 7]; i++;
talent[i] = [23, "Pyroclasm", 3, 4, 7]; i++; 
talent[i] = [23, "Shadow and Flame", 5, 2, 8]; i++;
talent[i] = [23, "Improved Soul Leech", 2, 3, 8]; i++;
talent[i] = [23, "Backdraft", 3, 1, 9]; i++;
talent[i] = [23, "Shadowfury", 1, 2, 9]; i++;
talent[i] = [23, "Empowered Imp", 3, 3, 9]; i++;
talent[i] = [23, "Fire and Brimstone", 5, 2, 10]; i++;
talent[i] = [23, "Chaos Bolt", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//arms talents
talent[i] = [24, "Improved Heroic Strike", 3, 1, 1]; i++;
talent[i] = [24, "Deflection", 5, 2, 1]; i++;
talent[i] = [24, "Improved Rend", 2, 3, 1]; i++;
talent[i] = [24, "Improved Charge", 2, 1, 2]; i++; 
talent[i] = [24, "Iron Will", 3, 2, 2]; i++;
talent[i] = [24, "Tactical Mastery", 3, 3, 2]; i++;
talent[i] = [24, "Improved Overpower", 2, 1, 3]; i++;
talent[i] = [24, "Anger Management", 1, 2, 3]; i++;
talent[i] = [24, "Impale", 2, 3, 3]; i++;
talent[i] = [24, "Deep Wounds", 3, 4, 3]; i++;
talent[i] = [24, "Two-Handed Weapon Specialization", 3, 2, 4]; i++;
talent[i] = [24, "Taste for Blood", 3, 3, 4]; i++;
talent[i] = [24, "Poleaxe Specialization", 5, 1, 5]; i++; 
talent[i] = [24, "Sweeping Strikes", 1, 2, 5]; i++;
talent[i] = [24, "Mace Specialization", 5, 3, 5]; i++;
talent[i] = [24, "Sword Specialization", 5, 4, 5]; i++;
talent[i] = [24, "Weapon Mastery", 2, 1, 6]; i++;
talent[i] = [24, "Improved Hamstring", 3, 3, 6]; i++;
talent[i] = [24, "Trauma", 2, 4, 6]; i++;
talent[i] = [24, "Second Wind", 2, 1, 7]; i++;
talent[i] = [24, "Mortal Strike", 1, 2, 7]; i++;
talent[i] = [24, "Strength of Arms", 2, 3, 7]; i++;
talent[i] = [24, "Improved Slam", 2, 4, 7]; i++;
talent[i] = [24, "Juggernaut", 1, 1, 8]; i++;
talent[i] = [24, "Improved Mortal Strike", 3, 2, 8]; i++;
talent[i] = [24, "Unrelenting Assault", 2, 3, 8]; i++;
talent[i] = [24, "Sudden Death", 3, 1, 9]; i++;
talent[i] = [24, "Endless Rage", 1, 2, 9]; i++;
talent[i] = [24, "Blood Frenzy", 2, 3, 9]; i++;
talent[i] = [24, "Wrecking Crew", 5, 2, 10]; i++;
talent[i] = [24, "Bladestorm", 1, 2, 11]; i++;

treeStartStop[t] = i -1;
t++;

//fury talents
talent[i] = [25, "Armored to the Teeth", 3, 1, 1]; i++;
talent[i] = [25, "Booming Voice", 2, 2, 1]; i++;
talent[i] = [25, "Cruelty", 5, 3, 1]; i++;
talent[i] = [25, "Improved Demoralizing Shout", 5, 2, 2]; i++;
talent[i] = [25, "Unbridled Wrath", 5, 3, 2]; i++;
talent[i] = [25, "Improved Cleave", 3, 1, 3]; i++;
talent[i] = [25, "Piercing Howl", 1, 2, 3]; i++;
talent[i] = [25, "Blood Craze", 3, 3, 3]; i++;
talent[i] = [25, "Commanding Presence", 5, 4, 3]; i++;
talent[i] = [25, "Dual Wield Specialization", 5, 1, 4]; i++;
talent[i] = [25, "Improved Execute", 2, 2, 4]; i++;
talent[i] = [25, "Enrage", 5, 3, 4]; i++;
talent[i] = [25, "Precision", 3, 1, 5]; i++;
talent[i] = [25, "Death Wish", 1, 2, 5]; i++;
talent[i] = [25, "Improved Intercept", 2, 3, 5]; i++;
talent[i] = [25, "Improved Berserker Rage", 2, 1, 6]; i++;
talent[i] = [25, "Flurry", 5, 3, 6]; i++;
talent[i] = [25, "Intensify Rage", 3, 1, 7]; i++;
talent[i] = [25, "Bloodthirst", 1, 2, 7]; i++;
talent[i] = [25, "Improved Whirlwind", 2, 4, 7]; i++;
talent[i] = [25, "Furious Attacks", 2, 1, 8]; i++;
talent[i] = [25, "Improved Berserker Stance", 5, 4, 8]; i++;
talent[i] = [25, "Heroic Fury", 1, 1, 9]; i++;
talent[i] = [25, "Rampage", 1, 2, 9]; i++;
talent[i] = [25, "Bloodsurge", 3, 3, 9]; i++;
talent[i] = [25, "Unending Fury", 5, 2, 10]; i++;
talent[i] = [25, "Titan's Grip", 1, 2, 11]; i++;
...
//protection talents
talent[i] = [26, "Improved Bloodrage", 2, 1, 1]; i++;
talent[i] = [26, "Shield Specialization", 5, 2, 1]; i++;
talent[i] = [26, "Improved Thunder Clap", 3, 3, 1]; i++;
talent[i] = [26, "Incite", 3, 2, 2]; i++;
talent[i] = [26, "Anticipation", 5, 3, 2]; i++;
talent[i] = [26, "Last Stand", 1, 1, 3]; i++;
talent[i] = [26, "Improved Revenge", 2, 2, 3]; i++;
talent[i] = [26, "Shield Mastery", 2, 3, 3]; i++;
talent[i] = [26, "Toughness", 5, 4, 3]; i++;
talent[i] = [26, "Improved Spell Reflection", 2, 1, 4]; i++;
talent[i] = [26, "Improved Disarm", 2, 2, 4]; i++;
talent[i] = [26, "Puncture", 3, 3, 4]; i++;
talent[i] = [26, "Improved Disciplines", 2, 1, 5]; i++;
talent[i] = [26, "Concussion Blow", 1, 2, 5]; i++;
talent[i] = [26, "Gag Order", 2, 3, 5]; i++;
talent[i] = [26, "One-Handed Weapon Specialization", 5, 3, 6]; i++;
talent[i] = [26, "Improved Defensive Stance", 2, 1, 7]; i++;
talent[i] = [26, "Vigilance", 1, 2, 7]; i++;
talent[i] = [26, "Focused Rage", 3, 3, 7]; i++;
talent[i] = [26, "Vitality", 3, 2, 8]; i++;
talent[i] = [26, "Safeguard", 2, 3, 8]; i++;
talent[i] = [26, "Warbringer", 1, 1, 9]; i++;
talent[i] = [26, "Devastate", 1, 2, 9]; i++;
talent[i] = [26, "Critical Block", 3, 3, 9]; i++;
talent[i] = [26, "Sword and Board", 3, 2, 10]; i++;
talent[i] = [26, "Damage Shield", 2, 3, 10]; i++;
talent[i] = [26, "Shockwave", 1, 2, 11]; i++;
...
"Increases the damage and healing done by your periodic damage and healing effects by 6%.",
"Increases the damage and healing done by your periodic damage and healing effects by 8%.",
"Increases the damage and healing done by your periodic damage and healing effects by 10%."
		];
i++;
...
rank[i] = [
"All non-periodic Druid spell criticals have a 33% chance to grace you with a blessing of nature, increasing your spell haste by 20% for 3 sec.",
"All non-periodic Druid spell criticals have a 66% chance to grace you with a blessing of nature, increasing your spell haste by 20% for 3 sec.",
"All non-periodic Druid spell criticals have a 100% chance to grace you with a blessing of nature, increasing your spell haste by 20% for 3 sec."
		];
i++;	
...
rank[i] = [
"Reducing the pushback suffered from damaging attacks while casting Starfire, Hibernate, and Hurricane by 23% and increases your total spell haste by 1%.",
"Reducing the pushback suffered from damaging attacks while casting Starfire, Hibernate, and Hurricane by 46% and increases your total spell haste by 2%.",
"Reducing the pushback suffered from damaging attacks while casting Starfire, Hibernate, and Hurricane by 69% and increases your total spell haste by 3%."
		];
i++;

//Lunar Guidance - Balance  TALENT DIFFERENT
rank[i] = [
"Increases your spell power by 2% of your total Intellect.",
"Increases your spell power by 4% of your total Intellect.",
"Increases your spell power by 6% of your total Intellect."
		];
i++;

//Insect Swarm - Balance TALENT DIFFERENT. Talent has trainable ranks
rank[i]=[
		"<span style=text-align:left;float:left;>6% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br>Instant cast<br>The enemy target is swarmed by insects, decreasing their chance to hit with melee and ranged attacks by 3% and causing 1290 Nature damage over 12 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;

//Improved Insect Swarm - Balance
rank[i] = [
"Increases your damage done by your Wrath spell to targets afflicted by your Insect Swarm by 2%, and increases the critical strike chance of your Starfire spell by 1% on targets afflicted by your Moonfire spell.",
"Increases your damage done by your Wrath spell to targets afflicted by your Insect Swarm by 4%, and increases the critical strike chance of your Starfire spell by 2% on targets afflicted by your Moonfire spell.",
"Increases your damage done by your Wrath spell to targets afflicted by your Insect Swarm by 6%, and increases the critical strike chance of your Starfire spell by 3% on targets afflicted by your Moonfire spell."
		];		
i++;

//Dreamstate - Balance
rank[i] = [
"Regenerate mana equal to 2% of your Intellect every 5 sec. even while casting, also increases your spell crit chance by 1%.",
"Regenerate mana equal to 4% of your Intellect every 5 sec. even while casting, also increases your spell crit chance by 2%.",
"Regenerate mana equal to 6% of your Intellect every 5 sec. even while casting, also increases your spell crit chance by 3%."
		];		
i++;

//Moonfury - Balance TALENT CHANGED 3.0.3
rank[i] = [
...
rank[i] = [
		"7% of base mana<br><span style=text-align:left;float:left;>Instant cast</span><br>Shapeshift into Moonkin Form. While in this form the armor contribution from cloth and leather items is increased by 370%, damage taken while stunned is reduced by 15% and all party members within 100 yards have their spell critical chance increased by 5%. Single target spell critical strikes in this form have a chance to instantly regenerate 2% of your total mana. The Moonkin can not cast healing spells while shapeshifted.<br><br>The act of shapeshifting frees the caster of Polymorph and Movement Impairing effects."
		];
i++;

//Improved Moonkin Form - Balance  			
rank[i] = [
"Your Moonkin Aura also causes affected targets to gain 1% haste and you to gain 4% of your spirit as additional spell damage.",
"Your Moonkin Aura also causes affected targets to gain 2% haste and you to gain 108% of your spirit as additional spell damage.",
"Your Moonkin Aura also causes affected targets to gain 3% haste and you to gain 12% of your spirit as additional spell damage."
		];
i++;
...
rank[i] = [
"Attacks done to you while in Moonkin form have a 5% chance to cause you to go into a Frenzy, increasing your arcane and nature damage by 10% and causes you to be immune to pushback while casting Balance spells and restores 2% base mana every 2 sec. Lasts 10 sec.",
"Attacks done to you while in Moonkin form have a 10% chance to cause you to go into a Frenzy, increasing your arcane and nature damage by 10% and causes you to be immune to pushback while casting Balance spells and restores 2% base mana every 2 sec. Lasts 10 sec.",
"Attacks done to you while in Moonkin form have a 15% chance to cause you to go into a Frenzy, increasing your arcane and nature damage by 10% and causes you to be immune to pushback while casting Balance spells and restores 2% base mana every 2 sec. Lasts 10 sec."
		];
i++;
...
"Your Starfire spell gains an additional 24% and your Wrath gains an additional 12% of your bonus damage effects.",
"Your Starfire spell gains an additional 32% and your Wrath gains an additional 16% of your bonus damage effects.",
"Your Starfire spell gains an additional 40% and your Wrath gains an additional 20% of your bonus damage effects."
		];
i++;

//Eclipse - Balance  			
rank[i] = [
"When you critically hit with Starfire, you have a 33% chance of increasing damage done by Wrath by 40%. When you critically hit with Wrath, you have a 20% chance of increasing your critical strike chance with Starfire by 20%. Effect lasts 15 sec and has a 30 sec cooldown.",
"When you critically hit with Starfire, you have a 66% chance of increasing damage done by Wrath by 40%. When you critically hit with Wrath, you have a 40% chance of increasing your critical strike chance with Starfire by 20%. Effect lasts 15 sec and has a 30 sec cooldown.",
"When you critically hit with Starfire, you have a 100% chance of increasing damage done by Wrath by 40%. When you critically hit with Wrath, you have a 60% chance of increasing your critical strike chance with Starfire by 20%. Effect lasts 15 sec and has a 30 sec cooldown."
		];
i++;

//Typhoon - Balance  //UPDATED TALENT DIFFERENT
rank[i] = [
"<span style=text-align:left;float:left;>20% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>20 sec cooldown</span><br>You summon a violent Typhoon that does 1190 Nature damage when in contact with hostile targets, knocking them back and dazing them for 6 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>10% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>3 min cooldown</span><br>Summons 3 treants to attack the enemy target for 30 sec.<br><br>This ability is usable while shapeshifted."
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>28% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1.5 min cooldown</span><br>You summon a flurry of stars from the sky on all targets within 30 yards of the caster, each dealing 433 to 503 Arcane damage. Also causes 78 Arcane damage to all nearby targets within 5 yards of the enemy target. Maximum 20 stars. Lasts 10 sec.<br>Shapeshifting into an animal form or mounting cancels the effect. Any effect which causes you to loose control of your character will suppress the starfall effect.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i] = [
"Increases the damage done by your Swipe ability by 10%.",
"Increases the damage done by your Swipe ability by 20%.",
"Increases the damage done by your Swipe ability by 30%."
		];
i++;		
...
//Savage Fury - Feral 
rank[i] = [
		"Increases the damage caused by your Claw, Rake, Mangle (Cat), Mangle (Bear) and Maul abilities by 15%.",
		"Increases the damage caused by your Claw, Rake, Mangle (Cat), Mangle (Bear) and Maul abilities by 30%."		
		];
i++;	
...
rank[i] = [
"Increases your expertise by 2, and you are refunded 40% of the energy cost of a finishing move if it fails to land.",
"Increases your expertise by 4, and you are refunded 80% of the energy cost of a finishing move if it fails to land."
		];
i++;
...
rank[i]=[
"Increases your healing spells by up to 10% of your Agility, and increases healing done to you by 10% while in Cat form. This effect does not stack with other similar effects.",
"Increases your healing spells by up to 20% of your Agility, and increases healing done to you by 20% while in Cat form. This effect does not stack with other similar effects."
		];
i++;		
...
rank[i]=[
"Increases all attributes by 2% and reduces the chance you'll be critically hit by melee attacks by 1% and increases your armor contribution from cloth and leather items in Bear Form and Dire Bear Form by 11%.",
"Increases all attributes by 4% and reduces the chance you'll be critically hit by melee attacks by 2% and increases your armor contribution from cloth and leather items in Bear Form and Dire Bear Form by 22%.",
"Increases all attributes by 6% and reduces the chance you'll be critically hit by melee attacks by 3% and increases your armor contribution from cloth and leather items in Bear Form and Dire Bear Form by 33%."
		];
i++;
...
rank[i]=[
"Reduces the duration of Fear effects by 10%, and reduces all damage taken while Stunned by 10% while in Cat Form.",
"Reduces the duration of Fear effects by 20%, and reduces all damage taken while Stunned by 20% while in Cat Form.",
"Reduces the duration of Fear effects by 30%, and reduces all damage taken while Stunned by 30% while in Cat Form."
		];
i++;

//Protector of the Pack - Feral  TALENT DIFFERENT (last number changed 1/2/3)
rank[i] = [
"Increases your attack power in Bear Form and Dire Bear Form by 2% and the damage you take is reduced by 4%.",
"Increases your attack power in Bear Form and Dire Bear Form by 4% and the damage you take is reduced by 8%.",
"Increases your attack power in Bear Form and Dire Bear Form by 6% and the damage you take is reduced by 12%."
		];
i++;		

//Predatory Instincts - Feral //UPDATED TALENT DIFFERENT (first number changed 3/7/10)
rank[i]=[
"While in Cat Form increases your damage from melee critical strikes by 5% and reduces the damage taken from area of effect attacks by 10%.",
"While in Cat Form increases your damage from melee critical strikes by 10% and reduces the damage taken from area of effect attacks by 20%.",
"While in Cat Form increases your damage from melee critical strikes by 15% and reduces the damage taken from area of effect attacks by 30%."
		];
i++;
...
"Your Shred, Maul and Mangle attacks cause an Infected Wound in the target. The Infected Wound reduces the movement speed of the target by 32% and the attack speed by 12%. Lasts 12 sec.",
"Your Shred, Maul and Mangle attacks cause an Infected Wound in the target. The Infected Wound reduces the movement speed of the target by 48% and the attack speed by 18%. Lasts 12 sec."
		];
i++;
...
//Rend and Tear - Feral
rank[i] = [
"Increases damage done by your Maul and Shred attacks on bleeding targets by 5%, and increases the critical strike chance of your Ferocious Bite ability on bleeding targets by 5%.",
"Increases damage done by your Maul and Shred attacks on bleeding targets by 10%, and increases the critical strike chance of your Ferocious Bite ability on bleeding targets by 10%.",
"Increases damage done by your Maul and Shred attacks on bleeding targets by 15%, and increases the critical strike chance of your Ferocious Bite ability on bleeding targets by 15%.",
"Increases damage done by your Maul and Shred attacks on bleeding targets by 20%, and increases the critical strike chance of your Ferocious Bite ability on bleeding targets by 20%.",
"Increases damage done by your Maul and Shred attacks on bleeding targets by 25%, and increases the critical strike chance of your Ferocious Bite ability on bleeding targets by 25%."
		];
i++;	
...
rank[i]=[
"Reduces the cast time of your Healing Touch spell by 0.1 sec and increases the physical damage you deal by 1%.",
"Reduces the cast time of your Healing Touch spell by 0.2 sec and increases the physical damage you deal by 2%.",
"Reduces the cast time of your Healing Touch spell by 0.3 sec and increases the physical damage you deal by 3%.",
"Reduces the cast time of your Healing Touch spell by 0.4 sec and increases the physical damage you deal by 4%.",
"Reduces the cast time of your Healing Touch spell by 0.5 sec and increases the physical damage you deal by 5%."
		];
i++;		
...
//Natural Shapeshifter - Restoration
rank[i] = [
"Reduces the mana cost of all shapeshifting by 30%.also redzuces your global cooldown of your Bear Form, Dire Bear Form and Cat Form by 0.5 sec.",
...
rank[i]=[
"Allows 8% of your Mana regeneration to continue while casting and causes your Enrage ability to instantly generate 4 rage.",
"Allows 16% of your Mana regeneration to continue while casting and causes your Enrage ability to instantly generate 7 rage.",
"Allows 24% of your Mana regeneration to continue while casting and causes your Enrage ability to instantly generate 10 rage."
		];
i++;
...
rank[i]=[
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated, your next Druid Nature spell with a casting time less than 10 sec. becomes an instant cast spell."
		];
i++;	
...
rank[i]=[
"Increases the effect of all nature healing spells by 2%.",
"Increases the effect of all nature healing spells by 4%.",
"Increases the effect of all nature healing spells by 6%.",
"Increases the effect of all nature healing spells by 8%.",
"Increases the effect of all nature healing spells by 10%."
		];
i++;	
...
rank[i]=[
		"<span style=text-align:left;float:left;>13% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>15 sec cooldown</span><br>Consumes a Rejuvenation or Regrowth effect on a friendly target to instantly heal them an amount equal to 12 sec. of Rejuvenation or 18 sec. of Regrowth.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i]=[
"Your critical strike chance with all spells is increased by 1% and critical strikes against you give you the Natural Perfection effect reducing all damage taken by 1%.  Stacks up to 3 times.  Lasts 8 sec.",
"Your critical strike chance with all spells is increased by 2% and critical strikes against you give you the Natural Perfection effect reducing all damage taken by 2%.  Stacks up to 3 times.  Lasts 8 sec.",
"Your critical strike chance with all spells is increased by 3% and critical strikes against you give you the Natural Perfection effect reducing all damage taken by 3%.  Stacks up to 3 times.  Lasts 8 sec."
		];
i++;

//Empowered Rejuvenation - Restoration 
rank[i]=[
"The bonus healing effects of your Druid healing over time spells is increased by 4%.",
"The bonus healing effects of your Druid healing over time spells is increased by 8%.",
"The bonus healing effects of your Druid healing over time spells is increased by 12%.",
"The bonus healing effects of your Druid healing over time spells is increased by 16%.",
"The bonus healing effects of your Druid healing over time spells is increased by 20%."
		];
i++;

//Living Seed - Restoration TALENT DIFFERENT
rank[i]=[
...
rank[i]=[
		"<span>Instant cast</span><br>Reduces the mana cost of your healing over time spells by 20% and grants the ability to shapeshift into the Tree of Life. While in this form you increase healing received by 6% for all party and raid members within 100 yards, and you can only cast Restoration spells in addition to Innervate, Barkskin, Nature's Grasp and Thorns spells.<br><br>The act of shapeshifting frees the caster of Polymorph and Movement Impairing effects."
		];
i++;

//IMPROVED TREE OF LIFE - Restoration 
rank[i]=[
"Increases your armor contribution from items while in Tree of Life Form by 67%, and increases your healing spell power by 4% of your spirit while in Tree of Life Form.",
"Increases your armor contribution from items while in Tree of Life Form by 144%, and increases your healing spell power by 8% of your spirit while in Tree of Life Form.",
"Increases your armor contribution from items while in Tree of Life Form by 200%, and increases your healing spell power by 12% of your spirit while in Tree of Life Form."
		];
i++;
...
rank[i]=[
"Increases your spell haste by 2% andreduces the base cooldown of your Lifebloom spell by 2%.",
"Increases your spell haste by 4% andreduces the base cooldown of your Lifebloom spell by 4%.",
"Increases your spell haste by 6% andreduces the base cooldown of your Lifebloom spell by 6%.",
"Increases your spell haste by 8% andreduces the base cooldown of your Lifebloom spell by 8%.",
"Increases your spell haste by 10% andreduces the base cooldown of your Lifebloom spell by 10%."
		];
i++;
...
rank[i]=[
		"<span style=text-align:left;float:left;>19% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br>Instant cast<span style=text-align:right;float:right;>6 sec cooldown</span><br>Heals up to 5 friendly party or raid members within 15 yards of the target for 1442 over 7 sec. The amount healed is applied quickly at first, and slows down as the Wild Growth reaches its full duration.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i] = [
"Aspect of the Viper - Reduces the damage penalty by 10%.<br/><br/>Aspect of the Monkey - Reduces the damage done to you while active by 2%<br/><br/>Aspect of the Hawk - Increases the attack power bonus by 30%<br/><br/>Aspect of the Dragonhawk - Combines the bonuses from Aspect of the Monkey and Hawk.",
		];		
i++;		
...
rank[i] = [ 
"Increases the damage done by your tamed pets by 3%.",
"Increases the damage done by your tamed pets by 6%.",
"Increases the damage done by your tamed pets by 9%.",
"Increases the damage done by your tamed pets by 12%.",
"Increases the damage done by your tamed pets by 15%."
		];
i++;		
...
rank[i] = [
"While your tamed pet is active, you and your pet will regenerate 1% of total health every 10 sec and increases healing done to you and your pet by 5%.",
"While your tamed pet is active, you and your pet will regenerate 2% of total health every 10 sec and increases healing done to you and your pet by 10%."
		];
i++;

//Intimidation - Beast Mastery TALENT DIFFERENT
rank[i] = [
		"<span style=text-align:left;float:left;>6% of base mana</span><span style=text-align:right;float:right;>100 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1 min cooldown</span><br>Command your pet to intimidate the target, causing a high amount of threat and stunning the target for 3 sec. Lasts 15 sec. This ability is usable while shapeshifted."
		];
i++;		
...
//Animal Handler - Beast Mastery TALENT CHANGED chance to hit to expertise
rank[i] = [
"Increases your pet's attack power by 5% and increases the duration of your Master's Call ability by 3 sec.",
"Increases your pet's attack power by 10% and increases the duration of your Master's Call ability by 6 sec."
		];
i++;		
...
rank[i] = [
"All party members have all damage increased by 1% within 100 yards of your pet. In addition, increases the damage dealt by Arcane Shot and Steady Shot by 3%.",
"All party members have all damage increased by 2% within 100 yards of your pet. In addition, increases the damage dealt by Arcane Shot and Steady Shot by 3%.",
"All party members have all damage increased by 3% within 100 yards of your pet. In addition, increases the damage dealt by Arcane Shot and Steady Shot by 3%."
...
rank[i] = [
		"<span style=text-align:left;float:left;>8% of base mana</span><span style=text-align:right;float:right;>100 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>2 min cooldown</span><br>Send your pet into a rage causing 50% additional damage for 10 sec. While enraged, the beast does not feel pity or remorse or fear and it cannot be stopped unless killed. This ability is usable while shapeshifted."
		];
i++;		
...
rank[i] = [
"When your pet is under the effects of Bestial Wrath, you also go into a rage causing 20% additional damage and reducing mana costs of all spells and effects by 50% for 10 sec. While enraged, you do not feel pity or remorse or fear and you cannot be stopped unless killed."
		];		
i++;
...
rank[i]=[
"Increases your tamed pet's damage by 4% and you and your pet's movement speed by 2% while your pet is active. This does not stack with other movement speed increasing effects.",
"Increases your tamed pet's damage by 8% and you and your pet's movement speed by 4% while your pet is active. This does not stack with other movement speed increasing effects.",
"Increases your tamed pet's damage by 12% and you and your pet's movement speed by 6% while your pet is active. This does not stack with other movement speed increasing effects.",
"Increases your tamed pet's damage by 16% and you and your pet's movement speed by 8% while your pet is active. This does not stack with other movement speed increasing effects.",
"Increases your tamed pet's damage by 20% and you and your pet's movement speed by 10% while your pet is active. This does not stack with other movement speed increasing effects."
		];
i++;

//Beast Mastery - Beast Mastery
rank[i] = [
"You master the art of Beast training, teaching you the ability to tame Exotic pets and increasing your total amount of Pet Skill points by 6. In addition your tamed pet's damage is increased by 10%."
		];		
i++;
...
rank[i] = [
"Reduces the pushback suffered from damaging attacks while casting Steady Shot by 23%, and increases your chance to hit by 1% and increases your chance to hit with ranged and meele attacks by 1%.",
"Reduces the pushback suffered from damaging attacks while casting Steady Shot by 46%, and increases your chance to hit by 2% and increases your chance to hit with ranged and meele attacks by 2%.",
"Reduces the pushback suffered from damaging attacks while casting Steady Shot by 70%, and increases your chance to hit by 3% and increases your chance to hit with ranged and meele attacks by 3%."
		];
i++;
...
rank[i] = [
"Increases the critical strike damage bonus of your ranged abilities by 4%.",
"Increases the critical strike damage bonus of your ranged abilities by 8%.",
"Increases the critical strike damage bonus of your ranged abilities by 12%.",
"Increases the critical strike damage bonus of your ranged abilities by 16%.",
"Increases the critical strike damage bonus of your ranged abilities by 20%."
		];
i++;	
...
rank[i] = [
		"<span style=text-align:left;float:left;>6% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><BR><span style=text-align:left;float:left;>10 sec cooldown</span><br><br>Requires Ranged Weapon<br>An aimed shot that increases ranged damage by 408 and reduces healing done to that target by 50%. Lasts 10 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;		
...
rank[i] = [
"Increases the damage done by your Serpent Sting and Wyvern Sting by 10% and the mana drained by your Viper Sting by 10%. In addition, reduces the chance your Sting over time damage will be dispelled by 10%.",
"Increases the damage done by your Serpent Sting and Wyvern Sting by 20% and the mana drained by your Viper Sting by 20%. In addition, reduces the chance your Sting over time damage will be dispelled by 20%.",
"Increases the damage done by your Serpent Sting and Wyvern Sting by 30% and the mana drained by your Viper Sting by 30%. In addition, reduces the chance your Sting over time damage will be dispelled by 30%."
		];
i++;		
...
rank[i] = [
"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated, this ability immediately finishes the cooldown of your other Hunter abilities, except Bestial Wrath."
		];
i++;		
...
rank[i]=[
"Increases all damage you deal when a ranged weapons is equipped by 1%.",
"Increases all damage you deal when a ranged weapons is equipped by 2%.",
"Increases all damage you deal when a ranged weapons is equipped by 3%.",
...
rank[i]=[
		"Instant cast<br>Increases the attack power of party and raid members within 100 yards by 5%. Lasts until cancelled."
		];
i++;		
...
rank[i]=[
"Increases your critical strike chance with ranged and meele attacks by 1%, and reduces the Mana cost of your Steady Shot, Aimed Shot and Chimera Shot by 5%.",
"Increases your critical strike chance with ranged and meele attacks by 2%, and reduces the Mana cost of your Steady Shot, Aimed Shot and Chimera Shot by 10%.",
"Increases your critical strike chance with ranged and meele attacks by 3%, and reduces the Mana cost of your Steady Shot, Aimed Shot and Chimera Shot by 15%.",
"Increases your critical strike chance with ranged and meele attacks by 4%, and reduces the Mana cost of your Steady Shot, Aimed Shot and Chimera Shot by 20%.",
"Increases your critical strike chance with ranged and meele attacks by 5%, and reduces the Mana cost of your Steady Shot, Aimed Shot and Chimera Shot by 25%."
		];
i++;	
...
"You have a 7% chance to shoot an additional shot when doing damage with your auto shot, dealing 80% weapon nature damage. Wild Quiver consumes no ammo.",
"You have a 10% chance to shoot an additional shot when doing damage with your auto shot, dealing 80% weapon nature damage. Wild Quiver consumes no ammo."
		];
i++;	
...
5% of base mana</span><span style=text-align:right;float:right;>\
35 yd range</span><br><span style=text-align:left;float:left;>\
...
rank[i]=[
"Increases the damage done by your shots and the damage done by your tamed pet's special abilities by 1% on market targets, and increases the critical strike damage bonus of your Aimed Shot, Steady Shot, Kill Shot or Chimera Shot by 2%.",
"Increases the damage done by your shots and the damage done by your tamed pet's special abilities by 2% on market targets, and increases the critical strike damage bonus of your Aimed Shot, Steady Shot, Kill Shot or Chimera Shot by 4%.",
"Increases the damage done by your shots and the damage done by your tamed pet's special abilities by 3% on market targets, and increases the critical strike damage bonus of your Aimed Shot, Steady Shot, Kill Shot or Chimera Shot by 6%.",
"Increases the damage done by your shots and the damage done by your tamed pet's special abilities by 4% on market targets, and increases the critical strike damage bonus of your Aimed Shot, Steady Shot, Kill Shot or Chimera Shot by 8%.",
"Increases the damage done by your shots and the damage done by your tamed pet's special abilities by 5% on market targets, and increases the critical strike damage bonus of your Aimed Shot, Steady Shot, Kill Shot or Chimera Shot by 10%."
];
i++;		
...
rank[i]=[
		"<span style=text-align:left;float:left;>10% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>10 sec cooldown</span><span style=text-align:left;float:left;>Requires Ranged Weapon</span><br><br/>You deal 110% weapon damage, refreshing the current Sting on your target and triggering an effect:<br/><br/> Serpent Sting - Instantly deals 30% of the damage done by your Serpent Sting.<br/><br/> Viper Sting - Instantly restores mana to you equal to 60% of the total amount drained by your Viper Sting.<br/><br/> Scorpid Sting - Attempts to Disarm the target for 10 sec. This effect cannot occur more than once per 1 minute."
		];
i++;		
...
//Entrapment - Survival
rank[i]=[
"When your Frost Trap or Snake Trap is triggered you entrap all affected targets, preventing them from moving for 2 sec.",
"When your Frost Trap or Snake Trap is triggered you entrap all affected targets, preventing them from moving for 3 sec.",
"When your Frost Trap or Snake Trap is triggered you entrap all affected targets, preventing them from moving for 4 sec."
		];
i++;

//Trap Mastery - Survival
rank[i]=[
"Frost Trap and Freezing Trap- Increases the duration by 10%.<br><br>Immolation Trap, Explosive Trap and Black Arrow - Increase the periodic damage done by 10%.<br><br>Snake Trap - Increases the number of snakes summoned by 2.",
"Frost Trap and Freezing Trap- Increases the duration by 20%.<br><br>Immolation Trap, Explosive Trap and Black Arrow - Increase the periodic damage done by 20%.<br><br>Snake Trap - Increases the number of snakes summoned by 4.",
"Frost Trap and Freezing Trap- Increases the duration by 30%.<br><br>Immolation Trap, Explosive Trap and Black Arrow - Increase the periodic damage done by 30%.<br><br>Snake Trap - Increases the number of snakes summoned by 6."
		];
i++;	

//Survival Instincts - Survival
rank[i]=[
"Reduces all damage taken by 1% and increases the critical strike chance of your Arcane Shot, Steady Shot, and Explosive Shot by 2%.",
"Reduces all damage taken by 2% and increases the critical strike chance of your Arcane Shot, Steady Shot, and Explosive Shot by 4%."
		];
i++;
...
rank[i]=[
"Reduces the mana cost of all traps Hunter melee abilities and Black Arrow by 20% and reduces the cooldown of all traps and Black Arrow by 2 sec.",
"Reduces the mana cost of all traps Hunter melee abilities and Black Arrow by 40% and reduces the cooldown of all traps and Black Arrow by 4 sec.",
"Reduces the mana cost of all traps Hunter melee abilities and Black Arrow by 60% and reduces the cooldown of all traps and Black Arrow by 6 sec."
		];
i++;	
...
rank[i]=[
		"<span style=text-align:left;float:left;>6% of base mana</span><span style=text-align:right;float:right;>5-25 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1 min cooldown</span>span style=text-align:left;float:left;>Requires Ranged Weapon</span><br>A stinging shot that puts the target to sleep for 30 sec. Any damage will cancel the effect. When the target wakes up, the Sting causes 2460 Nature damage over 6 sec. Only one Sting per Hunter can be active on the target at a time.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;	
...
rank[i]=[
"Your successful ranged attacks have a 10% chance to increase your critical strike chance with all ranged and melee attacks by 2% for 8 sec.",
"Your successful ranged attacks have a 10% chance to increase your critical strike chance with all ranged and melee attacks by 4% for 8 sec.",
"Your successful ranged attacks have a 10% chance to increase your critical strike chance with all ranged and melee attacks by 6% for 8 sec.",
"Your successful ranged attacks have a 10% chance to increase your critical strike chance with all ranged and melee attacks by 8% for 8 sec.",
"Your successful ranged attacks have a 10% chance to increase your critical strike chance with all ranged and melee attacks by 10% for 8 sec."
		];
i++;
...
rank[i]=[
"Increases the critical strike chance of all of your ranged and melee attacks on targets affected by your Frost Trap, Freezing Trap and Freezing Arrow by 3%.",
"Increases the critical strike chance of all of your ranged and melee attacks on targets affected by your Frost Trap, Freezing Trap and Freezing Arrow by 6%."
		];
i++;
	
//Black Arrow - Survival
rank[i]=[
		"<span style=text-align:left;float:left;>5% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Requires Ranged Weapon<br>Fires a Black Arrow at the target increasing all damage done by you to the target by 6% and dealing 786 Shadow damage over 15 seconds. Black Arrow shares a cooldown with Trap spells.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;	
...
rank[i]=[
"Increases the critical strike chance of your Kill Shot abiity by 5% an while standing still for 6 sec. you gain Sniper Training increasing the damage done by your Steady Shot, Aimed Shot, Black Arrow and Explosive Shots by 3% for 15 sec.",
"Increases the critical strike chance of your Kill Shot abiity by 10% an while standing still for 6 sec. you gain Sniper Training increasing the damage done by your Steady Shot, Aimed Shot, Black Arrow and Explosive Shots by 6% for 15 sec.",
"Increases the critical strike chance of your Kill Shot abiity by 15% an while standing still for 6 sec. you gain Sniper Training increasing the damage done by your Steady Shot, Aimed Shot, Black Arrow and Explosive Shots by 9% for 15 sec."
		];
i++;	

//Hunting Party - Survival
rank[i]=[
"Increases your total Agility by an additional 1% and your Arcane Shot, Explosive Shot and Steady Shot critical strikes have a 33% chance to grant up to 10 party or raid members mana regeneration equal to 1% of their maximum mana per 5 seconds. Lasts for 15 sec.",
"Increases your total Agility by an additional 2% and your Arcane Shot, Explosive Shot and Steady Shot critical strikes have a 66% chance to grant up to 10 party or raid members mana regeneration equal to 1% of their maximum mana per 5 seconds. Lasts for 15 sec.",
"Increases your total Agility by an additional 3% and your Arcane Shot, Explosive Shot and Steady Shot critical strikes have a 100% chance to grant up to 10 party or raid members mana regeneration equal to 1% of their maximum mana per 5 seconds. Lasts for 15 sec.",
...
rank[i] = [
		"<span style=text-align:left;float:left;>6% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Requires Ranged Weapon<br>You fire an explosive charge into the enemy target, dealing 121-139 Fire damage. The charge will blast the target every second for an additional 2 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;	
...
rank[i] = [
		"Reduces the chance your helpful Mage spells and damage over time effects will be dispelled by 15% and reduces the threat caused by your Arcane spells by 20%.",
...
//Arcane Focus - Arcane
rank[i] = [
		"Increases your chance to hit and reduces the mana cost of your Mage Arcane spells by 1%.",
		"Increases your chance to hit and reduces the mana cost of your Mage Arcane spells by 2%.",
		"Increases your chance to hit and reduces the mana cost of your Mage Arcane spells by 3%."
		];
i++;		
...
rank[i] = [
	"Gives you a 2% chance of entering a Clearcasting state after any damaging Mage spell hits a target. The Clearcasting state reduces the mana cost of your next damaging Mage spell by 100%.",
	"Gives you a 4% chance of entering a Clearcasting state after any damaging Mage spell hits a target. The Clearcasting state reduces the mana cost of your next damaging Mage spell by 100%.",
	"Gives you a 6% chance of entering a Clearcasting state after any damaging Mage spell hits a target. The Clearcasting state reduces the mana cost of your next damaging Mage spell by 100%.",
	"Gives you a 8% chance of entering a Clearcasting state after any damaging Mage spell hits a target. The Clearcasting state reduces the mana cost of your next damaging Mage spell by 100%.",
	"Gives you a 10% chance of entering a Clearcasting state after any damaging Mage spell hits a target. The Clearcasting state reduces the mana cost of your next damaging Mage spell by 100%."
		];
i++;		

//Magic Attunement - Arcane
rank[i] = [
"Increases the range of your Mage Arcane spells by 3 yards and the effect of your Amplify Magic and Dampen Magic spells by 25%.",
...
rank[i] = [
		"<span style=text-align:left;float:left;>5% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><br>Increases the target's chance to critically hit with all spells by 3%. When the target critically hits the caster's chance to critically hit with spells is increased by 3% for 10 sec."
		];
i++;	
...
rank[i] = [
		"Allows 8% of your Mana regeneration to continue while casting, and increases spell haste by 1%",
		"Allows 16% of your Mana regeneration to continue while casting, and increases spell haste by 2%",
		"Allows 24% of your Mana regeneration to continue while casting, and increases spell haste by 3%"
		];
i++;	

//Torment the Weak - Arcane		
rank[i] = [
"Your Frostbolt, Fireball, Frostfire Bolt, Pyroblast, Arcane Missiles, Arcane Blast and Arcane Barrage abilities deal 4% more damage to snared or slowedtargets.",
...
rank[i]=[
"Reduces all damage taken by 1% and reduces the fade time of your invisibility spell by 1 sec.",
"Reduces all damage taken by 2% and reduces the fade time of your invisibility spell by 2 sec.",
"Reduces all damage taken by 3% and reduces the fade time of your invisibility spell by 3 sec."
		];
i++;

//Arcane Instability - Arcane		
rank[i] = [
		"Increases the damage done by your arcane spells and your critical strike chance by 1%.",
		"Increases the damage done by your arcane spells and your critical strike chance by 2%.",
		"Increases the damage done by your arcane spells and your critical strike chance by 3%."
		];		
i++;
...
rank[i]=[
"Increases the damage of your Arcane Missiles spell by an amount equal to 15% of your spell power and the damage of your Arcane Blast and Arcane Barrage by 3% of your spell power. In addition increases the damage of all party and raid members within 100 yards by 1%.",
"Increases the damage of your Arcane Missiles spell by an amount equal to 30% of your spell power and the damage of your Arcane Blast and Arcane Barrage by 6% of your spell power. In addition increases the damage of all party and raid members within 100 yards by 2%.",
"Increases the damage of your Arcane Missiles spell by an amount equal to 45% of your spell power and the damage of your Arcane Blast and Arcane Barrage by 9% of your spell power. In addition increases the damage of all party and raid members within 100 yards by 3%."
		];
i++;
...
rank[i]=[
"Increases the damage absorbed by Mage wards, Mana shield, and Ice Barrier by 10/%.",
"Increases the damage absorbed by Mage wards, Mana shield, and Ice Barrier by 20%.",
"increases the damage absorbed by Mage wards, Mana shield, and Ice Barrier by 30%."
		];
i++;
...
"Reduces the cooldown of your Presence of Mind, Arcane Power and Invisibility spells by 30%. And the cooldown of your Evocation spell by 1 min.",
		];
i++;

//Mind Mastery - Arcane
rank[i]=[
"Increases spell power by 2% of your total intellect.",
"Increases spell power by 4% of your total intellect.",
"Increases spell power by 6% of your total intellect.",
"Increases spell power by 8% of your total intellect.",
"Increases spell power by 10% of your total intellect."
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>10% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><BR>Reduces target's movement speed by 60%, increases the time between ranged attacks by 60% and increases casting time by 30%. Lasts 15 sec. Slow can only affect one target at a time."
		];
i++;
...
//Spell Power - Arcane 
rank[i]=[
"Increases critical strike damage bonus of all Mage spells by 25%.",
"Increases critical strike damage bonus of all Mage spells by 50%."
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>15% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>3 sec cooldown</span><BR>Launches several missiles at the enemy target, causing 936 to 1144 Arcane damage.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i] = [
"When Interrupted or Silenced you have a 50% chance to become immune to the next interrupt or silence mechanics for 10 sec.",
"When Interrupted or Silenced you have a 100% chance to become immune tothe next interrupt or silence mechanics for 10 sec."
		];
i++;
...
//Flame Throwing - Fire	
rank[i] = [
			"Increases the range of your Mage Fire spells except Frostfire Bolt by 3 yards.",
			"Increases the range of your Mage Fire spells except Frostfire Bolt by 6 yards."
		];
i++;
...
//Impact - Fire			
rank[i] = [
			"Gives your damaging Mage spells a 4% chance to cause the next Fire Blast spell you cast to stun the target for 2 sec.",
			"Gives your damaging Mage spells a 7% chance to cause the next Fire Blast spell you cast to stun the target for 2 sec.",
			"Gives your damaging Mage spells a 10% chance to cause the next Fire Blast spell you cast to stun the target for 2 sec."
		];
i++;

//Pyroblast - Fire TALENT DIFFERENT has trainable ranks
rank[i] = [
		"<span style=text-align:left;float:left;>18% of base mana</span><span style=text-align:right;float:right;>35 yd range</span><br><span style=text-align:left;float:left;>5 sec cast</span><br>Hurls an immense fiery boulder that causes 148 to 195 Fire damage and an additional 56 Fire damage over 12 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];		
i++;
...
//Burning Soul - Fire
rank[i] = [
"Reduces the pushback suffered from damaging attacks while casting Mage Fire spells by 35% and reduces the threat caused by your Fire spells by 5%.",
"Reduces the pushback suffered from damaging attacks while casting Mage Fire spells by 70% and reduces the threat caused by your Fire spells by 10%."
		];
i++;		
...
//Pyromaniac - Fire	
rank[i] = [
			"Increases chance to critically hit by 1% and allows 8% of your mana regeneration to continue while casting.",
			"Increases chance to critically hit by 2% and allows 16% of your mana regeneration to continue while casting.",
			"Increases chance to critically hit by 3% and allows 24% of your mana regeneration to continue while casting."
		]; 
i++;
		
//Combustion - Fire
rank[i] = [
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br>When activated, this spell increases your critical strike damage bonus with Mage Fire spells by 50%, and causes each of your Mage Fire damage spell hits to increase your critical strike chance with Mage Fire damage spells by 10%. This effect lasts until you have caused 3 non-periodic critical strikes with Fire spells."
		];
i++;
		
//Molten Fury - Fire	
rank[i] = [
"Increases damage of all Mage spells against targets with less than 35% health by 6%.",
			"Increases damage of all Mage spells against targets with less than 35% health by 12%."
		]; 
i++;

//Fiery Payback - Fire	
rank[i] = [
"When below 35% health all damage taken is reduced by 3% and your Pyroblast spell's cast time is reduced by 1.75 secs while the cooldown is increased by 5 secs. In addition, meele and ranged attacks amde against you have a 5% chance to disarm your attacker's main hand and ranged weapon.",
"When below 35% health all damage taken is reduced by 6% and your Pyroblast spell's cast time is reduced by 3.5 secs while the cooldown is increased by 10 secs. In addition, meele and ranged attacks amde against you have a 10% chance to disarm your attacker's main hand and ranged weapon."
		]; 
i++;

//Empowered Fire - Fire	
rank[i] = [
			"Increases the damage of your Fireball, Frostfire Bolt and Pyrpblast spells by an amount equal to 5% of your spell power. In addition each time your Ignite talent causes damage you have a 33% chance to regain 2% of your base mana.",
			"Increases the damage of your Fireball, Frostfire Bolt and Pyrpblast spells by an amount equal to 10% of your spell power. In addition each time your Ignite talent causes damage you have a 66% chance to regain 2% of your base mana.",
			"Increases the damage of your Fireball, Frostfire Bolt and Pyrpblast spells by an amount equal to 15% of your spell power. In addition each time your Ignite talent causes damage you have a 100% chance to regain 2% of your base mana."
		]; 
i++;

//Firestarter - Fire TALENT DIFFERENT
rank[i] = [
"Your damaging Blast Wave and Dragon's Breath spells have a 50% chance to make your next Flamestrike spell instant cast and cost no mana. Lasts 10 sec. Increases the duration of your Dragon's Breath effect by 1 sec.",
"Your damaging Blast Wave and Dragon's Breath spells have a 100% chance to make your next Flamestrike spell instant cast and cost no mana. Lasts 10 sec. Increases the duration of your Dragon's Breath effect by 2 sec."
		]; i++;


//Dragon's Breath - Fire TALENT DIFFERENT has trainable ranks

rank[i] = [
		"<span style=text-align:left;float:left;>15% of base mana</span><BR><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>20 sec cooldown</span><br>Targets in a cone in front of the caster take 370 to 430 Fire damage and are Disoriented for 5 sec. Any direct damaging attack will revive targets. Turns off your attack when used.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
//Burnout - Fire	
rank[i] = [
"Increases your spell critical damage bonus with all Mage spells by 10% but your non periodic Mage spell criticals cost an additional 1% of the spell's cost.",
"Increases your spell critical damage bonus with all Mage spells by 20% but your non periodic Mage spell criticals cost an additional 2% of the spell's cost.",
"Increases your spell critical damage bonus with all Mage spells by 30% but your non periodic Mage spell criticals cost an additional 3% of the spell's cost.",
"Increases your spell critical damage bonus with all Mage spells by 40% but your non periodic Mage spell criticals cost an additional 4% of the spell's cost.",
"Increases your spell critical damage bonus with all Mage spells by 50% but your non periodic Mage spell criticals cost an additional 5% of the spell's cost."
		]; 
i++;

//Living Bomb - Fire TALENT DIFFERENT has trainable ranks				
rank[i] = [
		"<span style=text-align:left;float:left;>18% of base mana</span><span style=text-align:right;float:right;>35 yd range</span><br>The target becomes a Living Bomb, taking 1380 Fire Damage over 12 sec. After 12 sec or when the spell is dispelled, the target explodes dealing 306 Fire damage to all enemies within 10 yards.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
//Ice Shards - Frost
rank[i]=[
"Increases the critical strike damage bonus of your Mage Frost spells by 33%.",
"Increases the critical strike damage bonus of your Mage Frost spells by 66%.",
"Increases the critical strike damage bonus of your Mage Frost spells by 100%."
		];
i++;		
...
//Permafrost - Frost
rank[i]=[
			"Increases the duration of your Chill effects by 1 sec and reduces the target's speed by an additional 4% and reduces the targets healing received by 17%.",
			"Increases the duration of your Chill effects by 2 sec and reduces the target's speed by an additional 7% and reduces the targets healing received by 33%.",
			"Increases the duration of your Chill effects by 3 sec and reduces the target's speed by an additional 10% and reduces the targets healing received by 50%."
		];
i++;		
...
//Piercing Ice - Frost
rank[i]=[
"Increases the damage done by your Mage Frost spells by 1%.",
"Increases the damage done by your Mage Frost spells by 2%.",
"Increases the damage done by your Mage Frost spells by 3%."
		];
i++;		

//Icy Veins - Frost TALENT DIFFERENT
rank[i]=[
		"<span style=text-align:left;float:left;>2% of base mana</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>Hastens your spellcasting, increasing spell casting speed by 20% and reduces the pushback suffered from damaging attacks while casting mage spells by 100%. Lasts 20 sec."
		];
i++;		
...
rank[i]=[
"Reduces the mana cost of all spells by 2% and reduces the threat caused by your Frost spells by 4%.",
"Reduces the mana cost of all spells by 4% and reduces the threat caused by your Frost spells by 7%.",
"Reduces the mana cost of all spells by 6% and reduces the threat caused by your Frost spells by 10%."
		];
i++;		
		
//Shatter - Frost
rank[i]=[
"Increases the critical strike chance of all your Mage spells against frozen targets by 17%.",
"Increases the critical strike chance of all your Mage spells against frozen targets by 34%.",
"Increases the critical strike chance of all your Mage spells against frozen targets by 50%."
		];
i++;
...
//Cold Snap - Frost
rank[i]=[
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>8 min cooldown</span><br>When activated, this spell finishes the cooldown on all Frost Mage spells you recently cast."
		];
i++;	
...
"Increases your chance to critically hit with Frostbolt by an additional 1% and gives your Frost damage spells a 66% chance to apply the Winter's Chill effect, which increases the chance spells will critically hit the target by 1% for 15 sec. Stacks up to 5 times.",
"Increases your chance to critically hit with Frostbolt by an additional 1% and gives your Frost damage spells a 100% chance to apply the Winter's Chill effect, which increases the chance spells will critically hit the target by 1% for 15 sec. Stacks up to 5 times."
		];
i++;
...
//Ice Barrier - Frost TALENT DIFFERENT has trainable ranks
rank[i]=[
		"<span style=text-align:left;float:left;>16%% of base mana</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Instantly shields you, absorbing 3300 damage. Lasts 1 min. While the shield holds, spellcasting will not be delayed by damage.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;	
...
"Increases the damage of your Frostbolt spell by an amount equal to 15% of your spell power and reduces the cast time by 0.3 sec."
		];
i++;
...
//Brain Freeze - Frost
rank[i]=[
"Your Mage Frost damage spells have a 5% chance to cause your next Fireball or Frostfire Bolt spell to be instant cast and cost no mana.",
"Your Mage Frost damage spells have a 10% chance to cause your next Fireball or Frostfire Bolt spell to be instant cast and cost no mana.",
"Your Mage Frost damage spells have a 15% chance to cause your next Fireball or Frostfire Bolt spell to be instant cast and cost no mana."
		];
i++;
...
rank[i]=[
"Increases the duration of your Summon Water Elemental spell by 5 sec and your Frost Bolt spell has a 33% chance to grant up to 10 party or raid members mana regeneration equal to 1% of their total mana every 5 sec for 15 sec. This effect cannot occur more often than once every 6 sec.",
"Increases the duration of your Summon Water Elemental spell by 10 sec and your Frost Bolt spell has a 66% chance to grant up to 10 party or raid members mana regeneration equal to 1% of their total mana every 5 sec for 15 sec. This effect cannot occur more often than once every 6 sec.",
"Increases the duration of your Summon Water Elemental spell by 15 sec and your Frost Bolt spell has a 100% chance to grant up to 10 party or raid members mana regeneration equal to 1% of their total mana every 5 sec for 15 sec. This effect cannot occur more often than once every 6 sec."
		];
i++;
...
//Deep Freeze - Frost TALENT DIFFERENT has trainable ranks
rank[i]=[
"<span style=text-align:left;float:left;>7% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Stuns the target for 5 sec. Only usable on Frozen targets. Deals 1469 to 1741 damage to targets permanently immune to stuns.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
"Increases the damage done by your Seal of Righteousness, Seal of Vengeance and Seal of Corruption and their Judgement effects by 18%.",
"Increases the damage done by your Seal of Righteousness, Seal of Vengeance and Seal of Corruption and their Judgement effects by 24%.",
"Increases the damage done by your Seal of Righteousness, Seal of Vengeance and Seal of Corruption and their Judgement effects by 30%."
		];
i++;	
...
rank[i] = [
"Gives the target of your Lay on Hands spell 10% reduced physical damage taken for 15 sec. In addition, the cooldown for your Lay on Hands spell is reduced by 2 min.",
"Gives the target of your Lay on Hands spell 20% reduced physical damage taken for 15 sec. In addition, the cooldown for your Lay on Hands spell is reduced by 4 min."
		];		
i++;		
...
rank[i] = [
"Increases the effect of your Concentration Aura by an additional 5% and while Concentration Aura is active reduces the duration of any Silence or Interrupt effect used against an affected group member by 10%.  The duration reduction does not stack with any other effects.",
"Increases the effect of your Concentration Aura by an additional 10% and while Concentration Aura is active reduces the duration of any Silence or Interrupt effect used against an affected group member by 20%.  The duration reduction does not stack with any other effects.",
"Increases the effect of your Concentration Aura by an additional 15% and while Concentration Aura is active reduces the duration of any Silence or Interrupt effect used against an affected group member by 30%.  The duration reduction does not stack with any other effects."
		];i++;	
...
//Blessed Hands - Holy
rank[i] = [
"Reduces the mana cost of hand of Freedom, Hand of Sacrifice  and hand of Salvation by 15%, increases the effectiveness of Hand of Salvation by 50% and the effectiveness of Hand of Sacrifice y an additional 5%.",
"Reduces the mana cost of hand of Freedom, Hand of Sacrifice  and hand of Salvation by 30%, increases the effectiveness of Hand of Salvation by 100% and the effectiveness of Hand of Sacrifice y an additional 10%."
		];
i++;	

//Pure of Heart - Holy 
rank[i] = [
"Reduces the duration of Curse, Disease and Poison effects by 25%.",
"Reduces the duration of Curse, Disease and Poison effects by 50%."
		];
i++;		

//Divine Favor - Holy TALENT DIFFERENT
rank[i] = [
		"2% of base mana<br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>2 min cooldown</span><br>When activated, gives your next Flash of Light, Holy Light, or Holy Shock spell a 100% critical effect chance."
		];
i++;		
...
rank[i] = [
		"Reduces the mana cost of your Cleanse, Purify and Consecration spells by 5% and increases the critical strike chance of your Exorcism and Holy Wrath spells by 17%.",
		"Reduces the mana cost of your Cleanse, Purify and Consecration spells by 10% and increases the critical strike chance of your Exorcism and Holy Wrath spells by 35%."
		];
i++;		
...
//Holy Power - Holy
rank[i] = [
"Increases the critical damage of your Holy spells by 20%.",
"Increases the critical damage of your Holy spells by 40%.",
"Increases the critical damage of your Holy spells by 60%.",
"Increases the critical damage of your Holy spells by 80%.",
"Increases the critical damage of your Holy spells by 100%."
		];
i++;		

//Light's Grace - Holy
rank[i] = [
"Gives your Holy Light spell a 33% chance to reduce the cast time of your next Holy Light spell by 0.5 sec. This effect lasts 15 sec. Also passively increases the duration of Divine Shield and Divine Protection by 2 seconds.",
"Gives your Holy Light spell a 66% chance to reduce the cast time of your next Holy Light spell by 0.5 sec. This effect lasts 15 sec. Also passively increases the duration of Divine Shield and Divine Protection by 4 seconds.",
"Gives your Holy Light spell a 100% chance to reduce the cast time of your next Holy Light spell by 0.5 sec. This effect lasts 15 sec. Also passively increases the duration of Divine Shield and Divine Protection by 6 seconds."
		];
i++;		

//Holy Shock - Holy	TALENT DIFFERENT has trainable ranks	
rank[i] = [
"<span style=text-align:right;float:right;>Enemy: 20 yd range</span><br><span style=text-align:left;float:left;>14% of base mana</span><span style=text-align:right;float:right;>Friendly: 40 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Blasts the target with Holy energy, causing 1296 to 1402 Holy damage to an enemy, or 2401 to 2599 healing to an ally.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;		
...
//Holy Guidance - Holy
rank[i] = [
"Increases your healing spell power by 2% of your total Intellect.",
"Increases your healing spell power by 4% of your total Intellect.",
"Increases your healing spell power by 6% of your total Intellect.",
"Increases your healing spell power by 8% of your total Intellect.",
"Increases your healing spell power by 10% of your total Intellect."
		];
i++;
...
rank[i] = [
"Increases the Damage done by your Seal spells by 10% and your Judgement spells by 5%. Also your Judgement spells increase your haste by 1% for 1 min.",
"Increases the Damage done by your Seal spells by 20% and your Judgement spells by 10%. Also your Judgement spells increase your haste by 2% for 1 min.",
"Increases the Damage done by your Seal spells by 30% and your Judgement spells by 15%. Also your Judgement spells increase your haste by 3% for 1 min.",
"Increases the Damage done by your Seal spells by 40% and your Judgement spells by 20%. Also your Judgement spells increase your haste by 4% for 1 min.",
"Increases the Damage done by your Seal spells by 50% and your Judgement spells by 25%. Also your Judgement spells increase your haste by 5% for 1 min."
		];
i++;

//Infusion of Light - Holy
rank[i] = [
"Your Holy Shock critical hits reduce the cast time of your next Flash of Light spell by 0.75 sec or increase the critical strike chance of your next Holy Light by 10%. In addition causes your Flash of Light to heal targets with Sacred Shield for an additional 50% over 12 sec.",
"Your Holy Shock critical hits reduce the cast time of your next Flash of Light spell by 1.5 sec or increase the critical strike chance of your next Holy Light by 20%. In addition causes your Flash of Light to heal targets with Sacred Shield for an additional 100% over 12 sec."
		];
i++;

//Enlightened Judgements - Holy
rank[i] = [
"Increases the range of your Judgement of Light and Judgement of Wisdom spells by 15 yards and increases your chance to hit with all spells and attacks by 2%.",
"Increases the range of your Judgement of Light and Judgement of Wisdom spells by 30 yards and increases your chance to hit with all spells and attacks by 4%."
		];
i++;

//Beacon of Light - Holy TALENT DIFFERENT	
rank[i] = [
		"<span style=text-align:left;float:left;>26% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><br>The target becomes a Beacon of Light to all party and raid members within a 60 yard radius. Any heals you cast on party and raid members will also heal the Beacon for 25% of the amount healed. Only one target can be Beacon of Light at a time. Lasts 1 min."
		];
i++;
...
//Divinity - Protection
rank[i]=[
"Increases all healing done by your holy spells and all holy healing effects on you by 1%.",
"Increases all healing done by your holy spells and all holy healing effects on you by 2%.",
"Increases all healing done by your holy spells and all holy healing effects on you by 3%.",
"Increases all healing done by your holy spells and all holy healing effects on you by 4%.",
"Increases all healing done by your holy spells and all holy healing effects on you by 5%."
		];
i++;
...
//Stoicism - Protection
rank[i] = [
"Reduces the duration of all Stun effects by an additional 10% and reduces the chance your Paladin helpful spells and damage over time effects will be dispelled by an additional 10%.",
"Reduces the duration of all Stun effects by an additional 20% and reduces the chance your Paladin helpful spells and damage over time effects will be dispelled by an additional 20%.",
"Reduces the duration of all Stun effects by an additional 30% and reduces the chance your Paladin helpful spells and damage over time effects will be dispelled by an additional 30%."
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>30% off all damage taken by party members within 30 yards is redirected to the paladin (up to a maximum of 40% of the Paladin's health times the number of party members). Damage which reduces the Paladin below 20% health will break the effect. Lasts 10 sec."
		];
i++;
...
rank[i] = [
"Increases your armor value from items by 2% and increases threat generated from all skills by 2%.",
"Increases your armor value from items by 4% and increases threat generated from all skills by 4%.",
"Increases your armor value from items by 6% and increases threat generated from all skills by 6%.",
"Increases your armor value from items by 8% and increases threat generated from all skills by 8%.",
"Increases your armor value from items by 10% and increases threat generated from all skills by 10%."		
		];
i++;
	
//Divine Guardian - Protection 
rank[i] = [
"When Divine Sacrifice is activated, your party and raid members within 30 yards take  10% reduced damage for 6 sec. In addition, increases the duration of your Sacred Shield by 50% and the amount absorbed by 20%.",
"When Divine Sacrifice is activated, your party and raid members within 30 yards take  20% reduced damage for 6 sec. In addition, increases the duration of your Sacred Shield by 100% and the amount absorbed by 40%.",
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>5% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br>Instant cast<br>Places a Blessing on the friendly target, reducing damage taken from all sources by 3% for 10 min and increasing strenght and stamina by 10%. In addition, when the target blocks, parries, or dodges a melee attack the target will gain 2% of the maximum displayed mana. Players may only have one Blessing on them per Paladin at any one time."
		];
i++;		
...
rank[i] = [
		"Increases your total Stamina by 2%, reduces the cooldown of your Divine Shield spell by 30 sec.",
		"Increases your total Stamina by 4%, reduces the cooldown of your Divine Shield spell by 60 sec."
		];
i++;
...
rank[i] = [
		"A passive ability that gives you mana when healed by other friendly target spells. The amount of mana gained is equal to 5% of the amount healed.",
		"A passive ability that gives you mana when healed by other friendly target spells. The amount of mana gained is equal to 10% of the amount healed."
		];
i++;
...
rank[i]=[
"Damage taken that takes you below 35% health, is reduced by 7%. In addition, attacks that would otherwise kill you have a 33% chance to heal you by up to 10% of your maximum  health (amount healed based on defense). This healing effect cannot occur more often than once every 2min.",
"Damage taken that takes you below 35% health, is reduced by 14%. In addition, attacks that would otherwise kill you have a 66% chance to heal you by up to 20% of your maximum  health (amount healed based on defense). This healing effect cannot occur more often than once every 2min.",
"Damage taken that takes you below 35% health, is reduced by 20%. In addition, attacks that would otherwise kill you have a 100% chance to heal you by up to 30% of your maximum  health (amount healed based on defense). This healing effect cannot occur more often than once every 2min.",
...
rank[i]=[
"Increases your expertise by 1, total Stamina and chance to critically hit by 1%.",
"Increases your expertise by 2, total Stamina and chance to critically hit by 2%.",
"Increases your expertise by 3, total Stamina and chance to critically hit by 3%."
			];
i++;		

//Touched by the Light - Protection
rank[i] = [
		"Increases your spell power by an amount equal to 5% of your Strength and increases the amount healed by your critical heals by 10%.",
		"Increases your spell power by an amount equal to 10% of your Strength and increases the amount healed by your critical heals by 20%.",
		"Increases your spell power by an amount equal to 15% of your Strength and increases the amount healed by your critical heals by 30%."		
		];
i++;	
	
//Avenger's Shield - Protection TALENT DIFFERENT has trainable ranks
rank[i] = [
		"<span style=text-align:left;float:left;>20% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Hurls a holy shield at the enemy, dealing 376 to 450 Holy damage, Dazing them and then jumping to additional nearby enemies. Affects 3 total targets. Lasts 10 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i]=[
"Reduces spell damage taken by 3% and gives a 50% chance to refresh the duration of Divine Plea when you hit an enemy. In addition , your Divine Plea spell is 50% less likely to be dispelled.",
"Reduces spell damage taken by 6% and gives a 100% chance to refresh the duration of Divine Plea when you hit an enemy. In addition , your Divine Plea spell is 100% less likely to be dispelled."
			];
i++;	

//Shield of the Templar - Protection TALENT CHANGED
rank[i]=[
"Reduces all damage taken by 1% and grants your Avengers Shield a 33% chance to silence your targets for 3 sec.",
"Reduces all damage taken by 2% and grants your Avengers Shield a 66% chance to silence your targets for 3 sec.",
"Reduces all damage taken by 3% and grants your Avengers Shield a 100% chance to silence your targets for 3 sec."
			];
i++;	

//Judgements of the Just - Holy
rank[i] = [
"Reduces the cooldown of your Hammer of Justice by 5 sec, increases the duration of your Seal of Justce effect by 0.5 sec and your Judgement spells also reduce the melee attack speed of the target by 10%.",
"Reduces the cooldown of your Hammer of Justice by 10 sec, increases the duration of your Seal of Justce effect by 1 sec and your Judgement spells also reduce the melee attack speed of the target by 20%."
		];
i++;
...
rank[i]=[
"Gives the Paladin's damaging attacks a chance to reduce the target's attackpower by 23 for 10 sec.",
"Gives the Paladin's damaging attacks a chance to reduce the target's attackpower by 46 for 10 sec."
		];
i++;		
...
rank[i]=[
"10% of base mana<br/>Instant cast<br/>All meelee auto attacks deal 62 to 64 additional Holy damage to the target and up to 2 additional targets. Lasts 30 min.<br/><br/>Unleasing this Seal's energy will judge an enemy, instantly causing 145 to 146 Holy damage.<br><br>"
		];
i++;		
...
//Crusade - Retribution 
rank[i]=[
"Increases all Holy and Physical damage caused by 1% and all damage caused against Humanoids, Demons, Undead and Elementals by an additional 1%.",
"Increases all Holy and Physical damage caused by 2% and all damage caused against Humanoids, Demons, Undead and Elementals by an additional 2%.",
"Increases all Holy and Physical damage caused by 3% and all damage caused against Humanoids, Demons, Undead and Elementals by an additional 3%."
		];
i++;
...
rank[i] = [
		"Increases the damage done by your Retribution Aura by 50% and all damage caused by friendly targets affected by any of your Auras is increased by 3%."
		];
i++;		
...
rank[i]=[
"Increases the critical strike damage of your Judgement, Crusader Strike and Divine Storm abilities by 5% and when one of those abilities or your normal attacks critically hit the cast time of your next Flash of Light or Exorcism is reduced by 0.75 sec.",
"Increases the critical strike damage of your Judgement, Crusader Strike and Divine Storm abilities by 10% and when one of those abilities or your normal attacks critically hit the cast time of your next Flash of Light or Exorcism becomes instant cast."			
		];
i++;

//Repentance - Retribution TALENT DIFFERENT
rank[i]=[
		"<span style=text-align:left;float:left;>7% of base mana</span><span style=text-align:right;float:right;>20 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1 min cooldown</span><br>Puts the enemy target in a state of meditation, incapacitating them for up to 1 min. and removing the effect of Righteous Vengance. Any damage caused will awaken the target. Usable against Demons, Dragonkin, Giants, Humanoids and Undead."
		];
i++;		
...
rank[i]=[
"Your Judgement spells have a 33% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 1% of their maximum mana per 5 sec for 15 sec, and to immediately grant you 25% of your base mana.",
"Your Judgement spells have a 66% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 1% of their maximum mana per 5 sec for 15 sec, and to immediately grant you 25% of your base mana.",
"Your Judgement spells have a 100% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 1% of their maximum mana per 5 sec for 15 sec, and to immediately grant you 25% of your base mana."
		];
i++;	
...
rank[i]=[
		...
		"Increases the critical strike chance of all Judgements capable of a critical hit by 24% and reduces threat caused by all actions by 24% except when under the effects of Righteous Fury.",
		"Increases the critical strike chance of all Judgements capable of a critical hit by 30% and reduces threat caused by all actions by 30% except when under the effects of Righteous Fury."								
		];
i++;
...
rank[i]=[
		"Your Auras also increases casting, ranged and melee attack speeds by 1%.",
		"Your Auras also increases casting, ranged and melee attack speeds by 2%.",
		"Your Auras also increases casting, ranged and melee attack speeds by 3%."							
		];
i++;

//Crusader Strike - Retribution TALENT DIFFERENT
rank[i]=[
		"<span style=text-align:left;float:left;>4% of base mana</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Requires Melee Weapon<br>An instant strike that causes 75% weapon damage."						
		];
i++;

//Sheath of Light - Retribution 
rank[i]=[
"Increases your bonus spell healing by an amount equal to 4% of your attack power and your critical healing spells heal the target for 5% of the healed amount over 12 seconds.",
"Increases your bonus spell healing by an amount equal to 8% of your attack power and your critical healing spells heal the target for 10% of the healed amount over 12 seconds.",
"Increases your bonus spell healing by an amount equal to 12% of your attack power and your critical healing spells heal the target for 15% of the healed amount over 12 seconds.",
"Increases your bonus spell healing by an amount equal to 16% of your attack power and your critical healing spells heal the target for 20% of the healed amount over 12 seconds.",
"Increases your bonus spell healing by an amount equal to 20% of your attack power and your critical healing spells heal the target for 25% of the healed amount over 12 seconds."
		];
i++;	
...
rank[i]=[
		"When your Judgement, Cruader Strike and Divine Storm spells deal a critical strike, your target will take 10% additional damage over 8 sec.",
		"When your Judgement, Cruader Strike and Divine Storm spells deal a critical strike, your target will take 20% additional damage over 8 sec.",
		"When your Judgement, Cruader Strike and Divine Storm spells deal a critical strike, your target will take 30% additional damage over 8 sec.",
		"When your Judgement, Cruader Strike and Divine Storm spells deal a critical strike, your target will take 32% additional damage over 8 sec.",
		"When your Judgement, Cruader Strike and Divine Storm spells deal a critical strike, your target will take 40% additional damage over 8 sec.",
		];
i++;

//Divine Storm - Retribution TALENT DIFFERENT
rank[i]=[
		"<span style=text-align:left;float:left;>10% of base mana</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>10 sec cooldown</span><br>Requires Melee Weapon<br>An instant weapon attack that causes 110% of weapon damage to up to 4 enemies within 8 yards. The Divine Storm heals up to 3 party or raid members totalling 25% of the damage caused."						
		];
i++;
...
rank[i] = [
"Increases the damage done by your holy spells by 1%.",
"Increases the damage done by your holy spells by 2%.",
"Increases the damage done by your holy spells by 3%.",
"Increases the damage done by your holy spells by 4%.",
"Increases the damage done by your holy spells by 5%."
		];
i++;
...
rank[i] = [
		"Reduces the threat generated by your Holy and Discipline spells by 7% and reduces the chance your Priest helpful spells and damage over time effects will be dispelled by 10%.",
		"Reduces the threat generated by your Holy and Discipline spells by 14% and reduces the chance your Priest helpful spells and damage over time effects will be dispelled by 20%.",
		"Reduces the threat generated by your Holy and Discipline spells by 20% and reduces the chance your Priest helpful spells and damage over time effects will be dispelled by 30%.",
		];
...
rank[i] = [
		...
		"Reduces the mana cost of your Dispel Magic, Cure Disease, Abolish Disease and Mass Dispel spells by 20%.",
		"Reduces the mana cost of your Dispel Magic, Cure Disease, Abolish Disease and Mass Dispel spells by 30%."				
		];
...
rank[i] = [ 
		...
		"Reduces the mana cost of your instant cast spells by 3%.",
		"Reduces the mana cost of your instant cast spells by 12%.",
...
rank[i] = [
"Increases damage and healing done by your Holy and Shadow spells by 1%. In addition, your Mass Dispel cast time is reduced by 0.5 sec.",
"Increases damage and healing done by your Holy and Shadow spells by 2%. In addition, your Mass Dispel cast time is reduced by 1 sec."			
		];
...
"Increases your total Spirit by 8% and increases your spell haste by 8%.",
"Increases your total Spirit by 10% and increases your spell haste by 10%."
		];
...
rank[i] = [
		"Increases your spell critical effect chance by 1%, and after taking a critical hit you gain the Focused Will effect, reducing all damage taken by 1% and increasing healing effects on you by 1%.  Stacks up to 3 times.  Lasts 8 sec.",
		"Increases your spell critical effect chance by 2%, and after taking a critical hit you gain the Focused Will effect, reducing all damage taken by 2% and increasing healing effects on you by 2%.  Stacks up to 3 times.  Lasts 8 sec.",
		"Increases your spell critical effect chance by 3%, and after taking a critical hit you gain the Focused Will effect, reducing all damage taken by 3% and increasing healing effects on you by 3%.  Stacks up to 3 times.  Lasts 8 sec.",
		];
...
rank[i] = [
			"<span style=text-align:left;float:left;>12% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>2 min cooldown</span><br>Infuses the target with power, increasing spell casting speed by 20% and reducing the mana cost of all spells by 20%. Lasts 15 sec."
		];
i++;			
...
rank[i] = [
"Increases the critical effect chance of your Flash Heal, Greater Heal and Penance (Heal) spells by 2% on targets afflicted by the Weakened Soul effect. and you have a 50% chance to reduce all damage taken by 3% fpr 1 min to all friendly party and raid targets when you cast Power Word: Shield. This effect has a 15 sec cooldown.",
"Increases the critical effect chance of your Flash Heal, Greater Heal and Penance (Heal) spells by 4% on targets afflicted by the Weakened Soul effect. and you have a 100% chance to reduce all damage taken by 3% fpr 1 min to all friendly party and raid targets when you cast Power Word: Shield. This effect has a 15 sec cooldown."
		];
...
"When your Power Word: Shield is completely absorbed or dispelled you are instantly energized with 1.5% of your total mana, and you have a 66% chance to energize your shielded target with 2% total mana, 8 rage, 16 energy or 32 runic power. This effect can only occur once every 12 sec.",
"When your Power Word: Shield is completely absorbed or dispelled you are instantly energized with 1.5% of your total mana, and you have a 100% chance to energize your shielded target with 2% total mana, 8 rage, 16 energy or 32 runic power. This effect can only occur once every 12 sec.",
...
//Grace - Discipline 	
rank[i] = [
"Your Flash Heal, Greater Heal, and Penance spells have a 50% chance to bless the target with Grace, increasing all healing received from the Priest by 3%. This effect will stack up to 3 times. Effect lasts 15 sec. Grace only can be active on one target at a time.",
"Your Flash Heal, Greater Heal, and Penance spells have a 100% chance to bless the target with Grace, increasing all healing received from the Priest by 3%. This effect will stack up to 3 times. Effect lasts 15 sec. Grace only can be active on one target at a time."
		];
i++;	
...
rank[i]=[
			"<span style=text-align:right;float:right;>Enemy: 30 yd range</span><br><span style=text-align:left;float:left;>12% of base mana</span><span style=text-align:right;float:right;>Friendly: 40 yd range</span><br><span style=text-align:left;float:left;>Channeled</span><span style=text-align:right;float:right;>10 sec cooldown</span><br>Launches a volley of holy light at the target, causing 288 Holy damage to an enemy, or 1484 to 1676 healing to an ally every 1 sec for 2 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
...
rank[i] = [
"Reduces the pushback suffered from damaging attacks while casting any Priest healing spell by 35%.",
"Reduces the pushback suffered from damaging attacks while casting any Priest healing spell by 70%."
		];		
...
rank[i] = [
			"Increases the critical strike damage bonus of your Holy spells by 20%.",
			"Increases the critical strike damage bonus of your Holy spells by 40%.",
			"Increases the critical strike damage bonus of your Holy spells by 60%.",
			"Increases the critical strike damage bonus of your Holy spells by 80%.",
			"Increases the critical strike damage bonus of your Holy spells by 100%."
		];
...
rank[i]=[
			"<span style=text-align:left;float:left;>16% of base mana</span><br/><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>2 min cooldown</span><br>Instantly heals the caster for 3716 to 4384.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
];
...
rank[i] = [
			"Reduces your target's physical damage taken 3% for 15 sec after getting a critical effect from your Flash Heal, Heal, Greater Heal, Binding Heal, Penance, Prayer of Mending, Prayer of Healing, or Circle of Healing spell.",
			"Reduces your target's physical damage taken 6% for 15 sec after getting a critical effect from your Flash Heal, Heal, Greater Heal, Binding Heal, Penance, Prayer of Mending, Prayer of Healing, or Circle of Healing spell.",
			"Reduces your target's physical damage taken 9% for 15 sec after getting a critical effect from your Flash Heal, Heal, Greater Heal, Binding Heal, Penance, Prayer of Mending, Prayer of Healing, or Circle of Healing spell."
		];
...
rank[i] = [
			"Increases the damage of your Smite, Holy Fire, Holy Nova and Penance spells by 4%.",
			"Increases the damage of your Smite, Holy Fire, Holy Nova and Penance spells by 8%.",
			"Increases the damage of your Smite, Holy Fire, Holy Nova and Penance spells by 12%.",
			"Increases the damage of your Smite, Holy Fire, Holy Nova and Penance spells by 16%.",
			"Increases the damage of your Smite, Holy Fire, Holy Nova and Penance spells by 20%."
		];
...
"Your mana regeneration from spirit is increased by 48% for 8 sec after you critically heal with Flash Heal, Greater Heal, Binding Heal or Empowered Renew"
		];		
...
rank[i] = [
			"<span style=text-align:left;float:left;>13% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>0.5 sec cast</span><span style=text-align:right;float:right;>3 min cooldown</span><br>Creates a Holy Lightwell.  Friendly players can click the Lightwell to restore 4620 health over 6 sec. Attacks done to you equal to 30% of your total health will cancel the effect. Lightwell lasts for 3 min or 10 charges.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
...
rank[i] = [
			"Increases the effectiveness of your Holy healing spellsby 1% and critical hits made against you have a 20% chance to increase your resillience rating by 0.5 per level for 6 sec.",
			"Increases the effectiveness of your Holy healing spellsby 2% and critical hits made against you have a 40% chance to increase your resillience rating by 0.5 per level for 6 sec.",
			"Increases the effectiveness of your Holy healing spellsby 3% and critical hits made against you have a 60% chance to increase your resillience rating by 0.5 per level for 6 sec."
		];
...
rank[i] = [
			"When you cast Power Word: Shield, you increase the target's moovement speed by 30% for 4sec. and you have a 50% chance when you cast Abolish Disease on yourself to also cleanse 1 poison effect in addition to diseases.",
			"When you cast Power Word: Shield, you increase the target's moovement speed by 60% for 4sec. and you have a 100% chance when you cast Abolish Disease on yourself to also cleanse 1 poison effect in addition to diseases."
		];
...
//Serendipity - Holy
rank[i]=[
"When you heal with Binding Heal or Flash Heal, the cast time of your next Greater Heal or Prayer of Healing spell is reduced by 4%. Stacks up 3 times. Lasts 20 sec.",
"When you heal with Binding Heal or Flash Heal, the cast time of your next Greater Heal or Prayer of Healing spell is reduced by 8%. Stacks up 3 times. Lasts 20 sec.",
"When you heal with Binding Heal or Flash Heal, the cast time of your next Greater Heal or Prayer of Healing spell is reduced by 12%. Stacks up 3 times. Lasts 20 sec."
			];
i++;

//Empowered Renew - Holy
rank[i] = [
"Your Renew spell gains an additional 5% of your bonus healing effects, and your Renew will instantly heal the target for 5% of the total preiodic effect.",
"Your Renew spell gains an additional 10% of your bonus healing effects, and your Renew will instantly heal the target for 10% of the total preiodic effect.",
"Your Renew spell gains an additional 15% of your bonus healing effects, and your Renew will instantly heal the target for 15% of the total preiodic effect."
		];
...
rank[i]=[
			"<span style=text-align:left;float:left;>16% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Heals up to 5 friendly party or raid members within 15 yards of the target for 684 to 756. Circle of Healing shares cooldwon with Wild Growth.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
			];
i++;
...
//Spirit Tap - Shadow
rank[i]=[
"Gives you a 33% chance to gain a 30% bonus to your Spirit after killing a target that yields experience or honor.  For the duration, your Mana will regenerate at a 85% rate while casting. Lasts 15 sec.",
"Gives you a 66% chance to gain a 30% bonus to your Spirit after killing a target that yields experience or honor.  For the duration, your Mana will regenerate at a 85% rate while casting. Lasts 15 sec.",
"Gives you a 100% chance to gain a 30% bonus to your Spirit after killing a target that yields experience or honor.  For the duration, your Mana will regenerate at a 85% rate while casting. Lasts 15 sec."
			];
i++;
...
"Your Mind Blast and Shadow Word: Death critical strikes increase your total Spirit by 10%. For the duration, your mana will regenerate at a 35% rate while casting. Lasts 8 sec."
			];
i++;
...
rank[i]=[
			"Reduces the cooldown of your Mind Blast spell by 0.5 sec., and while in Shadowform your Mind Blast also has a 20% chance to rduce all healing done by 50%.",
			"Reduces the cooldown of your Mind Blast spell by 1 sec., and while in Shadowform your Mind Blast also has a 40% chance to rduce all healing done by 50%.",
			"Reduces the cooldown of your Mind Blast spell by 1.5 sec., and while in Shadowform your Mind Blast also has a 60% chance to rduce all healing done by 50%.",
			"Reduces the cooldown of your Mind Blast spell by 2 sec., and while in Shadowform your Mind Blast also has a 80% chance to rduce all healing done by 50%.",
			"Reduces the cooldown of your Mind Blast spell by 2.5 sec., and while in Shadowform your Mind Blast also has a 100% chance to rduce all healing done by 50%."
		];
...
rank[i]=[
			"<span style=text-align:left;float:left;>7% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br>Channeled<br>Assault the target's mind with Shadow energy, causing 588 Shadow damage over 3 sec and slowing the target to 50% of their movement speed.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
...
//Shadow Reach - Shadow
rank[i]=[
			"Increases the range of your offensive Priest Shadow spells by 10%.",
			"Increases the range of your offensive Priest Shadow spells by 20%."
		];
...
rank[i]=[
"Your damaging Priest Shadow spells have a 33% chance to increase the Shadow damage you deal by 2% for 15 sec. Stacks up to 5 times.",
"Your damaging Priest Shadow spells have a 66% chance to increase the Shadow damage you deal by 2% for 15 sec. Stacks up to 5 times.",
"Your damaging Priest Shadow spells have a 100% chance to increase the Shadow damage you deal by 2% for 15 sec. Stacks up to 5 times."
		];
...
rank[i]=[
			"<span style=text-align:left;float:left;>Instant cast</span><br>Fills you withthe embrace of Shadow energy, causing you to be healed for 15% and any other party members to be healed for 3% of any single target Priest Shadow damage you deal for 30 min."
		];
...
rank[i]=[
			"Increases the percentage healed by Vampiric Embrace by an additional 33%.",
			"Increases the percentage healed by Vampiric Embrace by an additional 66%."
		];
...
//Mind Melt - Shadow
rank[i]=[
"Increases the critical strike chance of your Mind Blast, Mind Flay, and Mind Sear spells by 2%, and increases the periodic critical strike chance of your vampiric Touch, Devouring Plague and Shadow Word: Pain by 3%.",
"Increases the critical strike chance of your Mind Blast, Mind Flay, and Mind Sear spells by 4%, and increases the periodic critical strike chance of your vampiric Touch, Devouring Plague and Shadow Word: Pain by 3%."		
		];
...
rank[i]=[
"Increases the periodic damage done by your Devouring Plague by 5%, and when you cast Devouring Plague you instantly deal damage equal to 7% of its total periodic effect.",
"Increases the periodic damage done by your Devouring Plague by 10%, and when you cast Devouring Plague you instantly deal damage equal to 14% of its total periodic effect.",
"Increases the periodic damage done by your Devouring Plague by 15%, and when you cast Devouring Plague you instantly deal damage equal to 20% of its total periodic effect."		
		];
...
rank[i]=[
			"10% of base mana<br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1.5 sec cooldown</span><br>Assume a Shadowform, increasing your Shadow damage by 15% and reducing all threat generated by 30%. However, you may not cast Healing spells while in this form. Grants the periodic damage from your Shadow Word: Pain, Devouring Plague, and Vampiric Touch spells the ability to critically hit for 100% increased damage and grants Devouring Plague and Vampiric Touch teh ability to benefit from haste."
		];
i++;		
...
rank[i]=[
"You take 5% reduced damage while in Shadowform. Your Fade ability now has a 50% chance to remove all movement impairing effects when used while in Shadowform, and reduces casting or channeling time lost when damaged by 35% when casting any Shadow spell while in Shadowform.",
"You take 10% reduced damage while in Shadowform. Your Fade ability now has a 100% chance to remove all movement impairing effects when used while in Shadowform, and reduces casting or channeling time lost when damaged by 70% when casting any Shadow spell while in Shadowform."										
		];
...
rank[i]=[
			"<span style=text-align:left;float:left;>13% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><span style=text-align:right;float:right;>120 sec cooldown</span><br>Instant<br>\
...
rank[i]=[
			"<span style=text-align:left;float:left;>13% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br>1.5 sec cast<br>\
			Causes 850 Shadow damage over 15 sec to your target and causes up to 10 party or raid members to gain 1% of their maximum mana per 5 sec when you deal damage from Mind Blast. In addition if Vampiric Touch is dispelled it will cause 1360 damage to the afflicted target.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];		
...
rank[i] = [
"After killing an opponent that yields experience or honor, gives you a 20% increased critical strike chance on your next Sinister Strike, Hemorrhage, Backstab, Mutilate, Hemorrhage, Ambush, or Ghostly Strike. Lasts 20 sec.",
"After killing an opponent that yields experience or honor, gives you a 40% increased critical strike chance on your next Sinister Strike, Hemorrhage, Backstab, Mutilate, Hemorrhage, Ambush, or Ghostly Strike. Lasts 20 sec."
		];
i++;		

//Malice - Assassination	
rank[i] = [
"Increases your meele and ranged critical strike chance by 1%.",
"Increases your meele and ranged critical strike chance by 2%.",
"Increases your meele and ranged critical strike chance by 3%.",
"Increases your meele and ranged critical strike chance by 4%.",
"Increases your meele and ranged critical strike chance by 5%."
		];
i++;		
		
//Ruthlessness - Assassination	
rank[i] = [
"Gives your Rogue melee finishing moves a 20% chance to add a combo point to your target.",
"Gives your Rogue melee finishing moves a 40% chance to add a combo point to your target.",
"Gives your Rogue melee finishing moves a 60% chance to add a combo point to your target."
		];
i++;		
...
rank[i] = [
"Increases the critical strike damage bonus of all combo point-generating Rogue abilities that do not require stealth by 6%.",
"Increases the critical strike damage bonus of all combo point-generating Rogue abilities that do not require stealth by 12%.",
"Increases the critical strike damage bonus of all combo point-generating Rogue abilities that do not require stealth by 18%.",
"Increases the critical strike damage bonus of all combo point-generating Rogue abilities that do not require stealth by 24%.",
"Increases the critical strike damage bonus of all combo point-generating Rogue abilities that do not require stealth by 30%.",		
	];
i++;		
...
"Increases the chance to apply Deadly Poison to your target by 8% and the frequency of applying Instant Poison to your target by 10%..",
"Increases the chance to apply Deadly Poison to your target by 12% and the frequency of applying Instant Poison to your target by 10%.",
"Increases the chance to apply Deadly Poison to your target by 16% and the frequency of applying Instant Poison to your target by 10%.",
"Increases the chance to apply Deadly Poison to your target by 20% and the frequency of applying Instant Poison to your target by 10%."
		];
i++;		

//Fleet Footed - Assassination	
rank[i] = [
"Reduces the duration of all movement impairing effects by 10% and increases your movement speed by 5%. This does not stack with other movement speed increasing effects.",
"Reduces the duration of all movement impairing effects by 20% and increases your movement speed by 10%. This does not stack with other movement speed increasing effects.",
...
rank[i] = [
"All healing effects on you are increased by 5%. This effect does not stack with other similar effects. In addition, your finishing moves cost 40% less Energy when they fail to hit.",
"All healing effects on you are increased by 10%. This effect does not stack with other similar effects. In addition, your finishing moves cost 80% less Energy when they fail to hit."
		];
i++;		

//Seal Fate - Assassination		
rank[i] = [
"Your critical strikes from Rogue abilities that add combo points have a 20% chance to add an additional combo point.",
"Your critical strikes from Rogue abilities that add combo points have a 40% chance to add an additional combo point.",
"Your critical strikes from Rogue abilities that add combo points have a 60% chance to add an additional combo point.",
"Your critical strikes from Rogue abilities that add combo points have a 80% chance to add an additional combo point.",
"Your critical strikes from Rogue abilities that add combo points have a 100% chance to add an additional combo point."
		];
i++;

//Murder - Assassination - TALENT DIFFERENT - values changed
rank[i] = [
"Increases all physical and nature damage caused by 1%",
"Increases all physical and nature damage caused by 2%"
		];
i++;		
...
rank[i] = [
"Increases the critical chance of all attacks made against any target you have poisoned by 1% and reduces the duration of all Poison effects applied to you by 17%. and gives Envenom a 33% chance to not consume Deadly Poison.",
"Increases the critical chance of all attacks made against any target you have poisoned by 2% and reduces the duration of all Poison effects applied to you by 34%. and gives Envenom a 33% chance to not consume Deadly Poison.",
"Increases the critical chance of all attacks made against any target you have poisoned by 3% and reduces the duration of all Poison effects applied to you by 50%. and gives Envenom a 33% chance to not consume Deadly Poison."
		];
i++;

//Mutilate - Assassination
rank[i] = [
			"<span style=text-align:left;float:left;>60 Energy</span><span style=text-align:right;float:right;>Melee range</span><br>Instant<br>Requires Daggers<br>Instantly attacks with both weapons for 100% weapon damage plus an additional 44 with each weapon. Damage is increased by 30% against Poisoned targets. Awards 2 combo points.<br><br>\
			&nbsp;Talent Has Trainable Ranks"
		];
i++;	
...
rank[i] = [
			"<span style=text-align:left;float:left;>15 Energy</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant</span><br>Enrages you, increasing all damage caused by 5%. Requires a bleed effect to be active on the target. Lasts 1 min.<br><br>This ability is usable while shapeshifted."
		];
i++;
...
"Increases your chance to hit with all spells and attacks by 2%.",
"Increases your chance to hit with all spells and attacks by 3%.",
"Increases your chance to hit with all spells and attacks by 4%.",
"Increases your chance to hit with all spells and attacks by 5%."
		];
i++;		
...
"Increases your chance to get a critical strike with Daggers and Fist Weapons by 6%.",
"Increases your chance to get a critical strike with Daggers and Fist Weapons by 8%.",
"Increases your chance to get a critical strike with Daggers and Fist Weapons by 10%."
];
i++;	
...
rank[i] = [
"Increases your Dodge chance by 1% and gives you 1% meele haste.",
"Increases your Dodge chance by 2% and gives you 2% meele haste.",
"Increases your Dodge chance by 3% and gives you 3% meele haste.",
"Increases your Dodge chance by 4% and gives you 4% meele haste.",
"Increases your Dodge chance by 5% and gives you 5% meele haste."
		];
i++;
...
//Blade Flurry - Combat  
rank[i]=[
			"25 Energy<br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br>Increases your attack speed by 20%. In addition, attacks strike an additional nearby opponent. Lasts 15 sec. This ability is usable while shapeshifted."
			];
i++;			
			
//Sword Specialization - Combat
rank[i]=[
"Gives you a 1% chance to get an extra attack on the same target after hitting your target with your One-Handed Sword or One-Handed Axe.",
"Gives you a 2% chance to get an extra attack on the same target after hitting your target with your One-Handed Sword or One-Handed Axe.",
"Gives you a 3% chance to get an extra attack on the same target after hitting your target with your One-Handed Sword or One-Handed Axe.",
"Gives you a 4% chance to get an extra attack on the same target after hitting your target with your One-Handed Sword or One-Handed Axe.",
"Gives you a 5% chance to get an extra attack on the same target after hitting your target with your One-Handed Sword or One-Handed Axe."
		];
i++;
...
rank[i]=[
"Increases your expertise by 2.",
"Increases your expertise by 4."
		];
i++;		
...
rank[i]=[
			"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>Increases your Energy regeneration rate by 100% for 15 sec. This ability is usable while shapeshifted."
		];
i++;		

//Nerves of Steel - Combat 
rank[i]=[
"Reduces the damage taken while affected by Stun and Fear effects by 3%.",
"Reduces the damage taken while affected by Stun and Fear effects by 6%."
		];
i++;
...
rank[i]=[
"Your critical strike damage is increased by 2% when the target has less health than you (as a percentage of total health).",
"Your critical strike damage is increased by 4% when the target has less health than you (as a percentage of total health).",
"Your critical strike damage is increased by 6% when the target has less health than you (as a percentage of total health).",
"Your critical strike damage is increased by 8% when the target has less health than you (as a percentage of total health).",
"Your critical strike damage is increased by 10% when the target has less health than you (as a percentage of total health)."
		];
i++;
...
rank[i]=[
"Causes your attacks to ignore 2% of your target's Armor and increases the damage dealt by your Rupture ability by 10%.",
"Causes your attacks to ignore 4% of your target's Armor and increases the damage dealt by your Rupture ability by 20%.",
"Causes your attacks to ignore 6% of your target's Armor and increases the damage dealt by your Rupture ability by 30%."
		];
i++;
...
rank[i]=[
			"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>8 min cooldown</span><br>When activated, this ability immediately finishes the cooldown on your Evasion, Sprint, Vanish, Cold Blood and Shadowstep abilities. This ability is usable while shapeshifted."
		];
i++;		
	
//Dirty Deeds - Subtlety 
rank[i]=[
			"Reduces the Energy Cost of your Cheap Shot and Garrote abilities by 10. Additionally, your Rogue specials cause 10% more damage against targets below 35% health.",
			"Reduces the Energy Cost of your Cheap Shot and Garrote abilities by 20. Additionally, your Rogue specials cause 20% more damage against targets below 35% health."
		];
i++;	
		
//Hemorrhage - Subtlety 
rank[i]=[
			"<span style=text-align:left;float:left;>35 Energy</span><span style=text-align:right;float:right;5 yd</span><br>Instant<br>Requires Melee Weapon<br>An instant strike that deals 100% weapon damage (145% if a dagger is equipped) (80% if a two-hander is equipped) and causes the target to hemorrhage, increasing any Physical damage dealt to the target by up to 13.  Lasts 10 charges or 15 sec.  Awards 1 combo point.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;		
...
rank[i]=[
"Increases your total Agility by 2% and increases the percentage damage bonus of Backstab and Hemorrhage by an additional 2%.",
"Increases your total Agility by 4% and increases the percentage damage bonus of Backstab and Hemorrhage by an additional 4%.",
"Increases your total Agility by 6% and increases the percentage damage bonus of Backstab and Hemorrhage by an additional 6%.",
"Increases your total Agility by 8% and increases the percentage damage bonus of Backstab and Hemorrhage by an additional 8%.",
"Increases your total Agility by 10% and increases the percentage damage bonus of Backstab and Hemorrhage by an additional 10%."
		];
i++;	

//Waylay - Subtlety
rank[i]=[
"Your Ambush critical hits have a 50% chance to unbalance a target reducing the target's melee and ranged attack speed by 20%, movement speed by 50% for 8 sec.",
"Your Ambush critical hits have a 100% chance to unbalance a target reducing the target's melee and ranged attack speed by 20%, movement speed by 70% for 8 sec."
		];
i++;
...
//Shadowstep - Subtlety 
rank[i]=[
			"<span style=text-align:left;float:left;>10 Energy</span><span style=text-align:right;float:right;>25 yd range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Attempts to step through the shadows and reappear behind your enemy and increases movement speed by 70% for 3 sec. The damage of your next Rogue ability is increased by 20% and the threat caused is reduced by 50%. Lasts 10 sec. This ability is usable while shapeshifted."
		];
i++;

//Filthy Tricks - Subtlety
rank[i]=[
"Reduces the cooldown by 5 sec and the energy cost by 5 of your Tricks of the Tradel, Distract and Shadowstep abilities and reduces the cooldown of Preparation by 1.5 min.",
"Reduces the cooldown by 10 sec and the energy cost by 10 of your Tricks of the Tradel, Distract and Shadowstep abilities and reduces the cooldown of Preparation by 3 min."
		];
i++;

//Slaughter form the Shadows - Subtlety
rank[i]=[
"Reduces the energy cost of your Backstab and Ambush abilities by 4 and the energy cost of your Hemorrhage by 1, and increases all physical and nature damage done by 1%.",
"Reduces the energy cost of your Backstab and Ambush abilities by 8 and the energy cost of your Hemorrhage by 2, and increases all physical and nature damage done by 2%.",
"Reduces the energy cost of your Backstab and Ambush abilities by 12 and the energy cost of your Hemorrhage by 3, and increases all physical and nature damage done by 3%.",
"Reduces the energy cost of your Backstab and Ambush abilities by 16 and the energy cost of your Hemorrhage by 4, and increases all physical and nature damage done by 4%.",
"Reduces the energy cost of your Backstab and Ambush abilities by 20 and the energy cost of your Hemorrhage by 5, and increases all physical and nature damage done by 5%."
		];
i++;

//Shadow Dance - Subtlety 
rank[i]=[
			"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>1 min cooldown</span><br>Enter the Shadow Dance for 6 sec, allowing the use of Sap, Garrotte, Ambush, Cheap Shot, Premeditation, Pickpocket and Disarm Trap regardless of being stealthed."
		];
i++;
...
"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Burst and Shock spells by 8%.",
"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Burst and Shock spells by 10%."
		];
i++;		
...
rank[i] = [
"After landing a critical strike with a Fire, Frost, or Nature damage spell, you enter a Clearcasting state.  The Clearcasting state reduces the mana cost of your next 2 damage or healing spells by 20%."
		];		
i++;		
...
rank[i] = [
"Increases the critical strike damage bonus of your Searing and Magma Totems and your Fire, Frost, and Nature shaman spells by 20%.",
"Increases the critical strike damage bonus of your Searing and Magma Totems and your Fire, Frost, and Nature shaman spells by 40%.",
"Increases the critical strike damage bonus of your Searing and Magma Totems and your Fire, Frost, and Nature shaman spells by 60%.",
"Increases the critical strike damage bonus of your Searing and Magma Totems and your Fire, Frost, and Nature shaman spells by 80%.",
"Increases the critical strike damage bonus of your Searing and Magma Totems and your Fire, Frost, and Nature shaman spells by 100%."
		];
i++;
...
"Increases the damage done by your Fire Nova by 20% and reduces the cooldown by 2 sec."
		];
i++;		
...
rank[i] = [
"Increases the range of your Lightning Bolt, Chain Lightning, Fire Nova and Lava Burst spells by 3 yards, increases the radius of your Thunderstorm spell by 10% and increases the the range of your Flame Shock by 7 yards.",
"Increases the range of your Lightning Bolt, Chain Lightning, Fire Nova and Lava Burst spells by 6 yards, increases the radius of your Thunderstorm spell by 20% and increases the the range of your Flame Shock by 14 yards."
		];
i++;	
...
rank[i] = [
"Regenerate mana equal to 2% of your Intellect every 5 sec, even while casting. Also increases your spell hit chance by 1%.",
"Regenerate mana equal to 4% of your Intellect every 5 sec, even while casting. Also increases your spell hit chance by 1%.",
"Regenerate mana equal to 6% of your Intellect every 5 sec, even while casting. Also increases your spell hit chance by 1%.",
"Regenerate mana equal to 8% of your Intellect every 5 sec, even while casting. Also increases your spell hit chance by 1%.",
"Regenerate mana equal to 10% of your Intellect every 5 sec, even while casting. Also increases your spell hit chance by 1%."
		];
i++;		

//Elemental Precision - Elemental 
rank[i] = [
"Increases your chance to hit with shaman Fire, Frost, and Nature spells by 1% and reduces the threat caused by shaman based Fire, Frost, and Nature spells by 10%.",
"Increases your chance to hit with shaman Fire, Frost, and Nature spells by 2% and reduces the threat caused by shaman based Fire, Frost, and Nature spells by 20%.",
"Increases your chance to hit with shaman Fire, Frost, and Nature spells by 3% and reduces the threat caused by shaman based Fire, Frost, and Nature spells by 30%."
		];
i++;		
...
rank[i] = [
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated, your next LKightning Bolt, Chain Lightning or Lava Burst spell becomes an instant cast spell. In addition you gain 15% spell haste for 15 sec. Elemental Mastery shares cooldown with Nature's Swiftness."
		];
i++;		
...
rank[i] = [
"Reduces the cooldown of your Flame Shock and Frost Shock spells by an additional 1 sec., and increases the direct damage done by your Flame Shock and Frost Shock spells by an additional 5%.",
"Reduces the cooldown of your Flame Shock and Frost Shock spells by an additional 2 sec., and increases the direct damage done by your Flame Shock and Frost Shock spells by an additional 10%.",
		];
i++;

//Elemental Oath - Elemental  
rank[i] = [
"While clearcasting from Elemental Focus is active you deal 5% more damage with fire nature and frost spells. In addition, party or raid members within 100 yards receive a 3% bonus to their spell critical strike chance.",
"While clearcasting from Elemental Focus is active you deal 10% more damage with fire nature and frost spells. In addition, party or raid members within 100 yards receive a 3% bonus to their spell critical strike chance."
		];
i++;
...
rank[i] = [
"When stunned, feared or silenced you shift into the Astral Plane reducing all damage taken by 3% for the duration of the stun, fear or silence effect.",
"When stunned, feared or silenced you shift into the Astral Plane reducing all damage taken by 6% for the duration of the stun, fear or silence effect.",
"When stunned, feared or silenced you shift into the Astral Plane reducing all damage taken by 9% for the duration of the stun, fear or silence effect."
		];
i++;

//Totem of Wrath - Elemental
rank[i] = [
	"5% of base mana<br>Instant cast<br>Tools: Fire Totem<br>Summons a Totem of Wrath with 5 health at the feet of the caster. The totem increases the spell power by 50 for all party and raid members, and increases the critical strike chance of spells and effects by 3% against all enemies within 40 yards. Lasts 5 min."
		];
i++;	
...
rank[i] = [
"Increases the damage caused by your Windfury Weapon effect by 5% increases the spell damage on your Flametongue Weapon by 10% and increases the bonus healing on your Earthliving Weapon by 33%.",
"Increases the damage caused by your Windfury Weapon effect by 10% increases the spell damage on your Flametongue Weapon by 20% and increases the bonus healing on your Earthliving Weapon by 66%.",
"Increases the damage caused by your Windfury Weapon effect by 15% increases the spell damage on your Flametongue Weapon by 30% and increases the bonus healing on your Earthliving Weapon by 100%."
		];
i++;
...
//Flurry - Enhancement
rank[i] = [
"Increases your melee attack speed by 2% for your next 3 swings after dealing a critical strike.",
"Increases your melee attack speed by 4% for your next 3 swings after dealing a critical strike.",
"Increases your melee attack speed by 6% for your next 3 swings after dealing a critical strike.",
"Increases your melee attack speed by 8% for your next 3 swings after dealing a critical strike.",
"Increases your melee attack speed by 10% for your next 3 swings after dealing a critical strike."
		];
i++;		
...
rank[i] = [
"Increases the damage caused by your Frostbrand Weapon and Windfury Weapon effect by 10%.",
"Increases the damage caused by your Frostbrand Weapon and Windfury Weapon effect by 20%.",
"Increases the damage caused by your Frostbrand Weapon and Windfury Weapon effect by 30%."
			];
i++;			
...
rank[i] = [
"Increases your expertise by 1 and increase all party and raid members attack power by 2% if within 100 yards of the Shaman.",
"Increases your expertise by 2 and increase all party and raid members attack power by 4% if within 100 yards of the Shaman.",
"Increases your expertise by 3 and increase all party and raid members attack power by 6% if within 100 yards of the Shaman.",
...
rank[i]=[
"Increases the damage done by your Lightning Bolt, Chain Lightning, Lava Lash and Shock spells by 5% on targets that are affected by your Frostbrand Attack effect, and your Frost Shock has a 50% chance to root the target in ice for 5 sec. when used on targets at or further than 15 yards from you.",
"Increases the damage done by your Lightning Bolt, Chain Lightning, Lava Lash and Shock spells by 10% on targets that are affected by your Frostbrand Attack effect, and your Frost Shock has a 100% chance to root the target in ice for 5 sec. when used on targets at or further than 15 yards from you."
		];
i++;

//Dual Wield Specialization - Enhancement
rank[i]=[
"Increases your chance to hit while dual wielding by an additional 1%.",
"Increases your chance to hit while dual wielding by an additional 2%.",
"Increases your chance to hit while dual wielding by an additional 3%."
		];
i++;		
...
"You have a 8% chance to hit your target with a Lightning Shield Orb charge when you deal damage with melee attacks and abilities, and your Lightning Shield gains 8 additional charges.",
"You have a 10% chance to hit your target with a Lightning Shield Orb charge when you deal damage with melee attacks and abilities, and your Lightning Shield gains 10 additional charges."
		];
i++;
		
//Lava Lash - Enhancement
rank[i]=[
"<span style=text-align:left;float:left;>3% of base mana</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>You charge your one-handed off-hand weapon with lava, instantly dealing 100% off-hand Weapon damage. Damage is increased by 25% if your off-hand weapon is enchanted with Flametongue."
		];
i++;		
...
rank[i]=[
"When you Stormstrikeyou have a 50% chance to immediatly grant you 20% of your base mana.",
"When you Stormstrikeyou have a 100% chance to immediatly grant you 20% of your base mana."
		];
i++;

//Mental Quickness - Enhancement
rank[i]=[
"Reduces the mana cost of your instant cast Shaman spells by 2% and increases your spell power by an amount equal to 4% of your attack power.",
"Reduces the mana cost of your instant cast Shaman spells by 4% and increases your spell power by an amount equal to 8% of your attack power.",
"Reduces the mana cost of your instant cast Shaman spells by 6% and increases your spell power by an amount equal to 12% of your attack power.",
"Reduces the mana cost of your instant cast Shaman spells by 8% and increases your spell power by an amount equal to 16% of your attack power.",
"Reduces the mana cost of your instant cast Shaman spells by 10% and increases your spell power by an amount equal to 20% of your attack power."
		];
i++;

//Shamanistic Rage - Enhancement 
rank[i]=[
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br>Reduces all damage taken by 30% and gives your successful melee attacks a chance to regenerate mana equal to 30% of your attack power. This spell is usable while stunned. Lasts 15 sec."
		];
i++;
...
rank[i] = [
"When you deal damage with a melee weapon, you have a chance to reduce the cast time of your next Lightning Bolt, Chain Lightning, Lesser Healing Wave, Chain Heal or Healing Wave Spell by 20%. Stacks up to 5 times. Lasts 30 seconds. This can only be used with shaman weapons.",
"When you deal damage with a melee weapon, you have a chance (higher than rank 1) to reduce the cast time of your next Lightning Bolt, Chain Lightning, Lesser Healing Wave, Chain Heal or Healing Wave Spell by 20%. Stacks up to 5 times. Lasts 30 seconds. This can only be used with shaman weapons.",
"When you deal damage with a melee weapon, you have a chance (higher than rank 2) to reduce the cast time of your next Lightning Bolt, Chain Lightning, Lesser Healing Wave, Chain Heal or Healing Wave Spell by 20%. Stacks up to 5 times. Lasts 30 seconds. This can only be used with shaman weapons.",
"When you deal damage with a melee weapon, you have a chance (higher than rank 3) to reduce the cast time of your next Lightning Bolt, Chain Lightning, Lesser Healing Wave, Chain Heal or Healing Wave Spell by 20%. Stacks up to 5 times. Lasts 30 seconds. This can only be used with shaman weapons.",
"When you deal damage with a melee weapon, you have a chance (higher than rank 4) to reduce the cast time of your next Lightning Bolt, Chain Lightning, Lesser Healing Wave, Chain Heal or Healing Wave Spell by 20%. Stacks up to 5 times. Lasts 30 seconds. This can only be used with shaman weapons."
...
rank[i] = [
	"<span style=text-align:left;float:left;>10% of base mana</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>Summons two Spirit Wolves under the command of the Shaman, lasting 45 sec. This ability is usable while shapeshifted."
		];
i++;
...
rank[i]=[
"Reduces the threat generated by your Shaman healing spells by 5% and reduces the chance your helpfull Shaman spells and damage over time effects will be dispelled by 10%.",
"Reduces the threat generated by your Shaman healing spells by 10% and reduces the chance your helpfull Shaman spells and damage over time effects will be dispelled by 20%.",
"Reduces the threat generated by your Shaman healing spells by 15% and reduces the chance your helpfull Shaman spells and damage over time effects will be dispelled by 30%."
		];
i++;		
		
//Tidal Focus - Restoration 
rank[i]=[
"Reduces the Mana cost of your Shaman healing spells by 2%.",
"Reduces the Mana cost of your Shaman healing spells by 4%.",
"Reduces the Mana cost of your Shaman healing spells by 6%.",
"Reduces the Mana cost of your Shaman healing spells by 8%.",
"Reduces the Mana cost of your Shaman healing spells by 10%."
		];
i++;		
		
//Improved Water Shield - Restoration      
rank[i]=[
"You have a 33% chance to instantly gain mana as if u consumed a Water Shield Orb, when you gain a critical effect from your Healing Wave or Riptide spells, 20% chance when yougain a critical effect from your Lesser Healing Wave spell and a 10% chance when you gain a critical effect from your Chain Heal spell.",
"You have a 66% chance to instantly gain mana as if u consumed a Water Shield Orb, when you gain a critical effect from your Healing Wave or Riptide spells, 40% chance when yougain a critical effect from your Lesser Healing Wave spell and a 20% chance when you gain a critical effect from your Chain Heal spell.",
"You have a 100% chance to instantly gain mana as if u consumed a Water Shield Orb, when you gain a critical effect from your Healing Wave or Riptide spells, 60% chance when yougain a critical effect from your Lesser Healing Wave spell and a 30% chance when you gain a critical effect from your Chain Heal spell."
		];
i++;		
...
rank[i]=[
"Reduces your target's physical damage taken by 3% for 15 sec after getting a critical effect from one of your Shaman healing spells.",
"Reduces your target's physical damage taken by 6% for 15 sec after getting a critical effect from one of your Shaman healing spells.",
"Reduces your target's physical damage taken by 9% for 15 sec after getting a critical effect from one of your Shaman healing spells."
		];
i++;	

//Restorative Totems - Restoration  
rank[i]=[
"Increases the effect of your Mana Spring Totem by 7% and increases the ammount healed by Healing Stream Totem by 15%.",
"Increases the effect of your Mana Spring Totem by 14% and increases the ammount healed by Healing Stream Totem by 30%.",
"Increases the effect of your Mana Spring Totem by 30% and increases the ammount healed by Healing Stream Totem by 45%.",
"Increases the effect of your Mana Spring Totem by 7% and increases the ammount healed by Healing Stream Totem by 15%.",
"Increases the effect of your Mana Spring Totem by 7% and increases the ammount healed by Healing Stream Totem by 15%."
		];
i++;	
...
rank[i]=[
"Increases the critical effect chance of your Shaman healing and lightning spells by 1%.",
"Increases the critical effect chance of your Shaman healing and lightning spells by 2%.",
"Increases the critical effect chance of your Shaman healing and lightning spells by 3%.",
"Increases the critical effect chance of your Shaman healing and lightning spells by 4%.",
"Increases the critical effect chance of your Shaman healing and lightning spells by 5%."
		];
i++;	
		
//Healing Way - Restoration  
rank[i]=[
"Increases the amount healed by your Healing Wave spell and the instant healing of Riptide by 8%.",
"Increases the amount healed by your Healing Wave spell and the instant healing of Riptide by 16%.",
"Increases the amount healed by your Healing Wave spell and the instant healing of Riptide by 24%."
		];
i++;

//Nature's Swiftness - Restoration
rank[i]=[
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br>When activated, your next Shaman Nature spell with a casting time less than 10 sec becomes an instant cast spell. Nature's Swiftness shares a cooldown with Elemental Mastery."
		];
i++;	
...
rank[i]=[
"Increases the effectiveness of your Nature healing spells by 2%.",
"Increases the effectiveness of your Nature healing spells by 4%.",
"Increases the effectiveness of your Nature healing spells by 6%.",
"Increases the effectiveness of your Nature healing spells by 8%.",
"Increases the effectiveness of your Nature healing spells by 10%."
		];
i++;

//Nature's Guardian - Restoration  
rank[i]=[
"Whenever a damaging attack brings you below 30% health, your maximum health is increased by 3% fpr 10 sec. and your threat level towards the attacker is reduced. 30 second cooldown.",
"Whenever a damaging attack brings you below 30% health, your maximum health is increased by 6% fpr 10 sec. and your threat level towards the attacker is reduced. 30 second cooldown.",
"Whenever a damaging attack brings you below 30% health, your maximum health is increased by 9% fpr 10 sec. and your threat level towards the attacker is reduced. 30 second cooldown.",
"Whenever a damaging attack brings you below 30% health, your maximum health is increased by 12% fpr 10 sec. and your threat level towards the attacker is reduced. 30 second cooldown.",
"Whenever a damaging attack brings you below 30% health, your maximum health is increased by 15% fpr 10 sec. and your threat level towards the attacker is reduced. 30 second cooldown."
		];
i++;
...
rank[i]=[
"<span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>5 min cooldown</span><br>Tools: Water Totem<br>Summons a Mana Tide Totem with 10% of the caster's health at the feet of the caster for 12 sec that restores 6% of total mana every 3 seconds to group members within 30 yards."
		];
i++;

//Cleanse Spirit - Restoration 
rank[i]=[
"<span style=text-align:left;float:left;>6% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br>Instant Cast<br>Cleanse the spirit of a friendly target, removing 1 poison effect, 1 disease effect, and 1 curse effect."
				];
i++;
...
rank[i]=[
"Increases your healing by an amount equal to 4% of your Intellect.",
"Increases your healing by an amount equal to 8% of your Intellect.",
"Increases your healing by an amount equal to 12% of your Intellect."
		];
i++;			
...
rank[i]=[
"When you cast Chain Heal or Riptide, you have a 20 % chance to lower the cast time of your Healing wave spell by 30% and increase the critical effect chance of your Lesser Healing Wave spell by 25%. In addition, your Healing Wave gains an additional 4% of your bonus healing effects and your Lesser Healing Wave gains an additional 2% of your bonus healing effects.",
"When you cast Chain Heal or Riptide, you have a 40 % chance to lower the cast time of your Healing wave spell by 30% and increase the critical effect chance of your Lesser Healing Wave spell by 25%. In addition, your Healing Wave gains an additional 8% of your bonus healing effects and your Lesser Healing Wave gains an additional 4% of your bonus healing effects.",
"When you cast Chain Heal or Riptide, you have a 60 % chance to lower the cast time of your Healing wave spell by 30% and increase the critical effect chance of your Lesser Healing Wave spell by 25%. In addition, your Healing Wave gains an additional 12% of your bonus healing effects and your Lesser Healing Wave gains an additional 6% of your bonus healing effects.",
"When you cast Chain Heal or Riptide, you have a 80 % chance to lower the cast time of your Healing wave spell by 30% and increase the critical effect chance of your Lesser Healing Wave spell by 25%. In addition, your Healing Wave gains an additional 16% of your bonus healing effects and your Lesser Healing Wave gains an additional 8% of your bonus healing effects.",
"When you cast Chain Heal or Riptide, you have a 100 % chance to lower the cast time of your Healing wave spell by 30% and increase the critical effect chance of your Lesser Healing Wave spell by 25%. In addition, your Healing Wave gains an additional 20% of your bonus healing effects and your Lesser Healing Wave gains an additional 10% of your bonus healing effects."
		];
i++;	

//Riptide - Restoration 
rank[i]=[
"<span style=text-align:left;float:left;>15% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Heals a friendly target for 639 to 691 and another 500 over 15 sec. Your next Chain heal cast on that primary target within 15 sec will consume the healing over time effect and increase the amount of the Chain Heal by 25%.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
				];
i++;
...
rank[i] = [
"Reduces the global cooldown of your Curses by 0.5 sec. Also increases the dmage done by Curse of Agony by 10%."
		];
i++;		
...
rank[i] = [
"Your Shadow Bolt and Haunt spells apply the Shadow Embrace effect, increasing all periodic affliction damage dealt to the target by you by 1%, and reduces all periodic healing done to the target by 2%. Lasts for 12 sec. Stacks up to 3 times.",
"Your Shadow Bolt and Haunt spells apply the Shadow Embrace effect, increasing all periodic affliction damage dealt to the target by you by 2%, and reduces all periodic healing done to the target by 4%. Lasts for 12 sec. Stacks up to 3 times.",
"Your Shadow Bolt and Haunt spells apply the Shadow Embrace effect, increasing all periodic affliction damage dealt to the target by you by 3%, and reduces all periodic healing done to the target by 6%. Lasts for 12 sec. Stacks up to 3 times.",
"Your Shadow Bolt and Haunt spells apply the Shadow Embrace effect, increasing all periodic affliction damage dealt to the target by you by 4%, and reduces all periodic healing done to the target by 8%. Lasts for 12 sec. Stacks up to 3 times.",
"Your Shadow Bolt and Haunt spells apply the Shadow Embrace effect, increasing all periodic affliction damage dealt to the target by you by 5%, and reduces all periodic healing done to the target by 10%. Lasts for 12 sec. Stacks up to 3 times."
		];
i++;
...
rank[i] = [
		"<span style=text-align:left;float:left;>5% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br>Instant cast<br>Reduces the target's movement speed by 30% for 12 sec. Only one Curse per Warlock can be active on any one target."
		];		
i++;		

//Improved Felhunter - Affliction
rank[i] = [
"Your Felhunter regains 4% of its maximum mana each time it hits with its Shadow Bit ability and the cooldown on that ability is reduced by 2 sec. In addition, increases the effect of your Felhunter's Fel Intelligence by 5%.",
"Your Felhunter regains 8% of its maximum mana each time it hits with its Shadow Bit ability and the cooldown on that ability is reduced by 2 sec. In addition, increases the effect of your Felhunter's Fel Intelligence by 10%."
		];
i++;
...
rank[i]=[
"When you deal damage with Corruption you have a 6% chance to increase your spell casting speed by 60% for 10 sec.",
"When you deal damage with Corruption you have a 7% chance to increase your spell casting speed by 20% for 12 sec.",
"When you deal damage with Corruption you have a 10% chance to increase your spell casting speed by 20% for 12 sec."
			];
i++;	

//Contagion - Affliction
rank[i] = [
"Increases the damage of Curse of Agony, Corruption and Seed of Corruption by 1% and reduces the chance your helpfull Affliction spells and damage over time effects will be dispelled by an additional 6%.",
"Increases the damage of Curse of Agony, Corruption and Seed of Corruption by 2% and reduces the chance your helpfull Affliction spells and damage over time effects will be dispelled by an additional 12%.",
"Increases the damage of Curse of Agony, Corruption and Seed of Corruption by 3% and reduces the chance your helpfull Affliction spells and damage over time effects will be dispelled by an additional 18%.",
"Increases the damage of Curse of Agony, Corruption and Seed of Corruption by 4% and reduces the chance your helpfull Affliction spells and damage over time effects will be dispelled by an additional 24%.",
"Increases the damage of Curse of Agony, Corruption and Seed of Corruption by 5% and reduces the chance your helpfull Affliction spells and damage over time effects will be dispelled by an additional 30%."
		];
i++;
...
rank[i] = [
"Increases the amount drained by your Drain Life by 10% while your health is at or below 20% health, and increases the damage done by your Warlock Shadow spells by 4% when your target is at or below 35% health.",
"Increases the amount drained by your Drain Life by 20% while your health is at or below 20% health, and increases the damage done by your Warlock Shadow spells by 8% when your target is at or below 35% health.",
"Increases the amount drained by your Drain Life by 30% while your health is at or below 20% health, and increases the damage done by your Warlock Shadow spells by 12% when your target is at or below 35% health."
		];
i++;

//Unstable Affliction - Affliction  
rank[i]=[
		"<span style=text-align:left;float:left;>12% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br>1.5 sec cast<br>Shadow energy slowly destroys the target, causing 660 damage over 15 sec. In addition, if the Unstable Affliction is dispelled it will cause 990 damage to the dispeller and silence them for 5 sec. Only one Unstable Affliction or Immolate per Warlock can be active on any one target.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
			];
i++;	
...
//Pandemic - Affliction
rank[i] = [
"Grants the periodic damage from your Corruption and Unstable Affliction spells the ability to critically hit for 100% increased damage, and increase the critical strike damage bonus of your Haunt spell by 100%.",
...
//HAUNT - Affliction 
rank[i] = [
"<span style=text-align:left;float:left;>10% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>1.5 sec cast</span><span style=text-align:right;float:right;>8 sec cooldown</span><br> You send a ghostly soul into the target, dealing 645 to 753 Shadow damage and increasing all damage done by your Warlock damage-over-time effects on the target by 20% for 12 sec. When the Haunt spell ends or is dispelled, the soul returns to you, healing you for 100% of the damage it did to the target.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;		
...
rank[i] = [
"Increases your total Stamina by 1%. Also increases the percentage of damage shared via your Soul Link by an additional 4%.",
"Increases your total Stamina by 2%. Also increases the percentage of damage shared via your Soul Link by an additional 7%.",
"Increases your total Stamina by 3%. Also increases the percentage of damage shared via your Soul Link by an additional 10%.",
"Increases your total Stamina by 4%. Also increases the percentage of damage shared via your Soul Link by an additional 4%.",
"Increases your total Stamina by 5%. Also increases the percentage of damage shared via your Soul Link by an additional 4%."
		];
i++;

//Fel Synergy - Demonology
rank[i] = [
"You have a 50% chance to heal your pet for 15% of the ammount of spell damage done by you.",
"You have a 100% chance to heal your pet for 15% of the ammount of spell damage done by you."
		];		
i++;		
...
rank[i] = [
"Increases the Stamina and Intellect of your Imp, Voidwalker, Succubus, Felhunter and Felguard by 20% and increases your maximum health and mana by 1%.",
"Increases the Stamina and Intellect of your Imp, Voidwalker, Succubus, Felhunter and Felguard by 40% and increases your maximum health and mana by 2%.",
"Increases the Stamina and Intellect of your Imp, Voidwalker, Succubus, Felhunter and Felguard by 60% and increases your maximum health and mana by 3%."
		];
i++;		
...
rank[i]=[
		"<span style=text-align:left;float:left;>13% of base mana</span><span style=text-align:right;float:right;>100 yd range</span><br>Instant cast<br>When active, 10% of all damage taken by the caster is taken by your Imp, Voidwalker, Succubus, Felhunter, Felguard, or enslaved demon instead.  That damage cannot be prevented. Lasts as long as the demon is active and controlled."
		];
i++;	
...
rank[i] = [
"Increases the effectiveness of your Demon Armor and Fel Armor spells by 33%.",
"Increases the effectiveness of your Demon Armor and Fel Armor spells by 66%.",
"Increases the effectiveness of your Demon Armor and Fel Armor spells by 100%."
		];
i++;	
...
rank[i]=[
"Increases the combat ratings gained by your conjured Firestone and Spellstone by 15%.",
"Increases the combat ratings gained by your conjured Firestone and Spellstone by 30%."
		];
i++;		
...
rank[i]=[
"Increases your critical strike chance by 1% and your summoned demons critical strike chance equal by 2%.",
"Increases your critical strike chance by 2% and your summoned demons critical strike chance equal by 4%.",
"Increases your critical strike chance by 3% and your summoned demons critical strike chance equal by 6%.",
"Increases your critical strike chance by 1% and your summoned demons critical strike chance equal by 8%.",
"Increases your critical strike chance by 1% and your summoned demons critical strike chance equal by 10%."
		];
i++;	
...
rank[i]=[
"When your Shadowbold, Incenerate or Soul Fire a target that is below 35% health, the cast time of Soul Fire spell is reduced by 20% for 10 sec. Soul Fire cast under the effect of Decimation cost no shard.",
"When your Shadowbold, Incenerate or Soul Fire a target that is below 35% health, the cast time of Soul Fire spell is reduced by 40% for 10 sec. Soul Fire cast under the effect of Decimation cost no shard."
		];
i++;	
...
rank[i]=[
	"<span style=text-align:left;float:left;>14% of base Mana</span><BR><span style=text-align:left;float:left;>10 sec cast</span><br>Reagents: Soul Shard<BR>Summons a Felguard under the command of the Warlock."
		];
i++;
...
//Nemesis - Demonology 
rank[i]=[
"Reduces the cooldown of your Demonic Empowerment, Metamoprhosis and Fel Domination spells by 10%.",
"Reduces the cooldown of your Demonic Empowerment, Metamoprhosis and Fel Domination spells by 20%.",
"Reduces the cooldown of your Demonic Empowerment, Metamoprhosis and Fel Domination spells by 30%."
		];
i++;

//Demonic Pact - Demonology - TALENT DIFFERENT - description changed
rank[i]=[
"Increases your Fire and Shadow spell damage by 1% and your pet's criticals apply the Demonic Pact effect to your party or raid members. Demonic Pact increases spell power by 2% of your Spell Damage for 12 sec. Does not work on Enslaved demons.",
"Increases your Fire and Shadow spell damage by 2% and your pet's criticals apply the Demonic Pact effect to your party or raid members. Demonic Pact increases spell power by 4% of your Spell Damage for 12 sec. Does not work on Enslaved demons.",
"Increases your Fire and Shadow spell damage by 3% and your pet's criticals apply the Demonic Pact effect to your party or raid members. Demonic Pact increases spell power by 6% of your Spell Damage for 12 sec. Does not work on Enslaved demons.",
"Increases your Fire and Shadow spell damage by 4% and your pet's criticals apply the Demonic Pact effect to your party or raid members. Demonic Pact increases spell power by 8% of your Spell Damage for 12 sec. Does not work on Enslaved demons.",
"Increases your Fire and Shadow spell damage by 5% and your pet's criticals apply the Demonic Pact effect to your party or raid members. Demonic Pact increases spell power by 10% of your Spell Damage for 12 sec. Does not work on Enslaved demons."
		];
i++;
...
"Reduces the Mana cost of your Destruction spells by 12%."
		];
i++;			
...
rank[i]=[
"Increases the damage done by your Fire spells by 1% and reduces the cast time of your Incinerate spell by 0.05 sec.",
"Increases the damage done by your Fire spells by 2% and reduces the cast time of your Incinerate spell by 0.10 sec.",
"Increases the damage done by your Fire spells by 3% and reduces the cast time of your Incinerate spell by 0.15 sec.",
"Increases the damage done by your Fire spells by 4% and reduces the cast time of your Incinerate spell by 0.20 sec.",
"Increases the damage done by your Fire spells by 5% and reduces the cast time of your Incinerate spell by 0.25 sec."
		];
i++;	
...
rank[i]=[
		...
		"<span style=text-align:left;float:left;>13% Base Mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><span style=text-align:right;float:right;>10 sec cooldown</span><br>Consumes an Immolate or Shadowflame effect on the target to instantyly deal damage equal to 60% of your Immolate or Shadowflame andcauses an additional 40% damage over 6 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;	
...
rank[i]=[
"Your Shadow Bolt, Shadowburn, Chaos Bolt, Shadowfury and Incinerate spells gain an additional 4% of your bonus spell damage effects.",
"Your Shadow Bolt, Shadowburn, Chaos Bolt, Shadowfury and Incinerate spells gain an additional 8% of your bonus spell damage effects.",
"Your Shadow Bolt, Shadowburn, Chaos Bolt, Shadowfury and Incinerate spells gain an additional 12% of your bonus spell damage effects.",
"Your Shadow Bolt, Shadowburn, Chaos Bolt, Shadowfury and Incinerate spells gain an additional 16% of your bonus spell damage effects.",
"Your Shadow Bolt, Shadowburn, Chaos Bolt, Shadowfury and Incinerate spells gain an additional 20% of your bonus spell damage effects."
		];
i++;

//Improved Soul Leech - Destruction 
rank[i]=[
"Your Soul Leech effect also restores mana to you and your summoned demon equal to 1% of maximum mana and has a 50% chance to grant up to 10 party or raid members mana equal to 1% of maximum mana per 5 sec. Lasts 15 sec.",
"Your Soul Leech effect also restores mana to you and your summoned demon equal to 2% of maximum mana and has a 100% chance to grant up to 10 party or raid members mana equal to 1% of maximum mana per 5 sec. Lasts 15 sec."
		];
i++;
...
rank[i]=[
		"<span style=text-align:left;float:left;>5% Base Mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>25 sec cooldown</span><br>Shadowfury is unleashed, causing 357 to 422 Shadow damage and stunning all enemies within 8 yds for 3 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i]=[
"Increases the damage done by your Imp by 10%, and all critical hits done by your Imp have a 33% chance to increase your spell critical hit chance for your next Warlock spell by 100%. This effect lasts 8 sec.",
"Increases the damage done by your Imp by 20%, and all critical hits done by your Imp have a 66% chance to increase your spell critical hit chance for your next Warlock spell by 100%. This effect lasts 8 sec.",
"Increases the damage done by your Imp by 30%, and all critical hits done by your Imp have a 100% chance to increase your spell critical hit chance for your next Warlock spell by 100%. This effect lasts 8 sec."
		];
i++;

//Fire and Brimstone - Destruction 
rank[i]=[
"Increases the damage done by your Incenerate and Chaos Bolt spells to targets affecte4d by your Immolate by 2% and the critical strike chance of your Conflagrate spell is increased by 5%.",
"Increases the damage done by your Incenerate and Chaos Bolt spells to targets affecte4d by your Immolate by 4% and the critical strike chance of your Conflagrate spell is increased by 10%.",
"Increases the damage done by your Incenerate and Chaos Bolt spells to targets affecte4d by your Immolate by 6% and the critical strike chance of your Conflagrate spell is increased by 15%.",
"Increases the damage done by your Incenerate and Chaos Bolt spells to targets affecte4d by your Immolate by 8% and the critical strike chance of your Conflagrate spell is increased by 20%.",
"Increases the damage done by your Incenerate and Chaos Bolt spells to targets affecte4d by your Immolate by 10% and the critical strike chance of your Conflagrate spell is increased by 25%."
		];
i++;

//Chaos Bolt - Destruction 
rank[i]=[
	"<span style=text-align:left;float:left;>6% Base Mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>2.5 sec cast</span><span style=text-align:right;float:right;>12 sec cooldown</span><BR> Sends a bolt of chaotic fire at the enemy, dealing 685 to 861 Chaos damage. Chaos Bolt cannot be resisted, and pierces through all absorption effects.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;
...
rank[i] = [
"Increases the amount of rage generated by your Charge ability by 5. Also decreases its cooldown by 2.5 seconds.",
"Increases the amount of rage generated by your Charge ability by 10. Also decreases its cooldown by 5 seconds."
		];
i++;		
...
rank[i] = [
"Greatly increases the threat generated by your Bloodthirst and Mortal Strike abilities when you are in Defensive Stance.",
"Greatly increases the threat generated by your Bloodthirst and Mortal Strike abilities when you are in Defensive Stance. (More effective than Rank 1).",
"Greatly increases the threat generated by your Bloodthirst and Mortal Strike abilities when you are in Defensive Stance. (More effective than Rank 2)."
		];
i++;		
...
//Impale - Arms	
rank[i] = [
"Increases the critical strike damage bonus of your Warrior abilities by 10%.",
"Increases the critical strike damage bonus of your Warrior abilities by 20%."
		];
i++;	
...
rank[i] = [
"<span style=color:eb0504>Requires Two-Handed Axes, Two-Handed Maces, Polearms, Two-Handed Swords</span><br><br>Increases the damage you deal with two-handed melee weapons by 1%.",
"<span style=color:eb0504>Requires Two-Handed Axes, Two-Handed Maces, Polearms, Two-Handed Swords</span><br><br>Increases the damage you deal with two-handed melee weapons by 2%.",
"<span style=color:eb0504>Requires Two-Handed Axes, Two-Handed Maces, Polearms, Two-Handed Swords</span><br><br>Increases the damage you deal with two-handed melee weapons by 3%."
		];
i++;	

//Taste for Blood - Arms
rank[i] = [
"Whenever your Rend ability causes damage, you have a 33% chance of allowing the use of your Overpower ability for 9 sec. 1 charge. This effect can not occur more than once every 6 sec.",
"Whenever your Rend ability causes damage, you have a 66% chance of allowing the use of your Overpower ability for 9 sec. 1 charge. This effect can not occur more than once every 6 sec.",
"Whenever your Rend ability causes damage, you have a 100% chance of allowing the use of your Overpower ability for 9 sec. 1 charge. This effect can not occur more than once every 6 sec."
		];
i++;
...
rank[i] = [
"<span style=text-align:left;float:left;>30 Rage</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Requires Battle Stance, Berserker Stance<br>Your next 5 melee attacks strike an additional nearby opponent."
		];
i++;

//Mace Specialization - Arms	
rank[i] = [
"Your attacks with maces have a 1% chance to stun your target for 3 sec.",
"Your attacks with maces have a 2% chance to stun your target for 3 sec.",
"Your attacks with maces have a 3% chance to stun your target for 3 sec.",
"Your attacks with maces have a 4% chance to stun your target for 3 sec.",
"Your attacks with maces have a 5% chance to stun your target for 3 sec."
		];		
i++;		
...
rank[i] = [
		"<span style=text-align:left;float:left;>30 Rage</span><span style=text-align:right;float:right;>Melee range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Requires Melee Weapon<br>A vicious strike that deals 110% weapon damage plus 380 and wounds the target, reducing the effectiveness of any healing by 50% for 10 sec.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];		
i++;
...
rank[i] = [
"Increases your Strength and Stamina by 1% and your Expertise by 1.",
...
//Juggernaut - Arms
rank[i] = [
"Your Charge ability is now usable while in combat. Following a Charge, your next Slam or Mortal Strike has an additional 25% chance to critically hit if used within 10 sec.",
		];
i++;
...
rank[i] = [
"Reduces the cooldown of your Overpower and Revenge abilities by 0.5 seconds and increases the damage done by both abilities by 10%. In addition, if you strike a player with overpower while they are casting, their magical damage and healing will be reduced by 25% for 6 sec.",
"Reduces the cooldown of your Overpower and Revenge abilities by 1 seconds and increases the damage done by both abilities by 20%. In addition, if you strike a player with overpower while they are casting, their magical damage and healing will be reduced by 25% for 6 sec."
		];
i++;
...
//Blood Frenzy - Arms
rank[i] = [
"Increases your melee attack speed by 1%. In addition your Rend and Deep Wound abilities also increase all physical damage caused to that target by 2%.",
"Increases your melee attack speed by 2%. In addition your Rend and Deep Wound abilities also increase all physical damage caused to that target by 4%."
		];
i++;
...
//Piercing Howl - Fury
rank[i] = [
		"10 Rage<br>Instant<br>Causes all enemies within 10 yards to be Dazed, reducing movement speed by 50% for 6 sec. This ability is usable while shapeshifted."
		];
i++;		
...
//Enrage - Fury
rank[i] = [
"Gives you a 30% chance to receive a 1% damage bonus for 12 sec after being the victim of a damaging attack. This effect does not stack with Wrecking Crew.",
...
"Gives you a 30% chance to receive a 3% damage bonus for 12 sec after being the victim of a damaging attack. This effect does not stack with Wrecking Crew.",
...
"Gives you a 30% chance to receive a 5% damage bonus for 12 sec after being the victim of a damaging attack. This effect does not stack with Wrecking Crew."
		];
i++;
...
rank[i]=[
"10 Rage<br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated you become enraged, increasing your physical damage by 20% but increasing all damage taken by 5%. Lasts 30 sec. This ability is usable while shapeshifted."
			];
i++;
...
rank[i]=[
"The Berserker Rage ability will generate 10 rage when used. Increases the duration of Berserker Rage by 2 sec.",
"The Berserker Rage ability will generate 20 rage when used. Increases the duration of Berserker Rage by 4 sec."
		];
i++;		
		
//Flurry - Fury
rank[i]=[
"Increases your armor penetration by 1% for your next 3 swings after dealing a melee critical strike.",
"Increases your armor penetration by 2% for your next 3 swings after dealing a melee critical strike.",
"Increases your armor penetration by 3% for your next 3 swings after dealing a melee critical strike.",
"Increases your armor penetration by 4% for your next 3 swings after dealing a melee critical strike.",
"Increases your armor penetration by 5% for your next 3 swings after dealing a melee critical strike."
		];
i++;		
...
//Bloodthirst - Fury
rank[i]=[
		"<span style=text-align:left;float:left;>20 Rage</span><span style=text-align:right;float:right;>Melee range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>4 sec cooldown</span><br>Instantly attack the target causing 260 damage. In addition, the next 3 successful melee attacks will restore 1% of max health. This effect lasts 8 sec. Damage is based on your attack power."
		];
i++;	
...
rank[i]=[
"Increases attack power by 3% and reduces threat caused by 2% while in Berserker Stance.",
"Increases attack power by 6% and reduces threat caused by 4% while in Berserker Stance.",
"Increases attack power by 9% and reduces threat caused by 6% while in Berserker Stance.",
"Increases attack power by 12% and reduces threat caused by 8% while in Berserker Stance.",
"Increases attack power by 15% and reduces threat caused by 10% while in Berserker Stance."
		];
i++;	
...
rank[i]=[
		" Increases ranged and melee criticalhit chance of all party and raid members within 100 yds by 5%."
		];
i++;
...
"Your Heroic Strike, Bloodthirst and Whirlwind hits have a 14% chance of making your next Slam instant for 5 sec.",
"Your Heroic Strike, Bloodthirst and Whirlwind hits have a 30% chance of making your next Slam instant for 5 sec."
		];
i++;
...
//Titan's Grip - Fury
rank[i] = [
"Allows you to equip two-handed axes, maces and swords in one hand. While you have aTwo-Handed weapon equipped in one hand. All damage done is reduced by 15%."
		];
i++;
...
rank[i]=[
"Increases damage of your Revenge ability 10% and causes your Revenge to strike an additional target for 50% damage.",
"Increases damage of your Revenge ability 20% and causes your Revenge to strike an additional target."
		];
i++;	
...
rank[i]=[
		"<span style=text-align:left;float:left;>15 Rage</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Requires Melee Weapon<br>Stuns the opponent for 5 sec and deals 426 damage (based on attack power)."
		];
i++;	
...
//Vitality - Protection
rank[i]=[
"Increases your total Strength and Stamina by 1% and your Expertise by 1.",
"Increases your total Strength and Stamina by 2% and your Expertise by 2.",
"Increases your total Strength and Stamina by 3% and your Expertise by 3."
		];
i++;	
...
rank[i] = [
"Your Charge, Intercept and Intervene abilities are now usable while in combat, while shapeshifted  and no longer have a stance requirement, but the cooldown on Charge is increased by 5 sec. In addition, your Intervene ability will remove all movement impairing effects."
		];
i++;

//Devastate - Protection - TALENT DIFFERENT - cost changed and trainable ranks removed
rank[i]=[
		"<span style=text-align:left;float:left;>15 Rage</span><span style=text-align:right;float:right;>Melee Range</span><br>Instant<br>Requires Shield<br>Requires Defensive Stance<br>Sunder the target's armor causing the Sunder Armor effect.  In addition, causes 120% of weapon damage plus 101 for each application of Sunder Armor on the target.  The Sunder Armor effect can stack up to 5 times.<br><br>\
		&nbsp;Talent Has Trainable Ranks"
		];
i++;	

//Critical Block - Protection
rank[i] = [
...
//Shockwave - Prtection
rank[i] = [
"<span style=text-align:left;float:left;>15 Rage</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>20 sec cooldown</span><br>Sends a wave of force in front of the warrior, causing 449 damage (based on attack power) and stunning all enemy targets within 10 yards in a frontal cone for 4 sec."
		];		
i++;
